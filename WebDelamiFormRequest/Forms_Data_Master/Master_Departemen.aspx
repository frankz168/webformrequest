<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Master_Departemen.aspx.cs" MasterPageFile="~/Site.Master" Inherits="WebDelamiFormRequest.Forms_Data_Master.Master_Departemen" %>
            ...
            <div id="C_PnlInput" runat="server" visible="false">
                ...
                <table>
                    <tr>
                        ...
                        <td class="FV270">
                            <asp:TextBox ID="text_id" runat="server" Width="250px" ReadOnly="true"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="FN150">
                            <asp:Label ID="label_kodedept" runat="server" Text="Kode Dept : "></asp:Label>
                        </td>
                        <td class="FV270">
                            <asp:TextBox ID="text_kodedept" runat="server" Width="250px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="FN150">
                            <asp:Label ID="label_dept" runat="server" Text="Departemen : "></asp:Label>
                        </td>
                        <td class="FV270">
                            <asp:TextBox ID="text_dept" runat="server" Width="250px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="FN150">
                            <asp:Label ID="label_ket" runat="server" Text="KET : "></asp:Label>
                        </td>
                        <td class="FV270">
                            <asp:TextBox ID="text_ket" runat="server" Width="250px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="FN150">
                ...
                <div class="EU_TableScroll" style="display: block; max-height: 1000px;">
                    <asp:GridView ID="gvMain" runat="server" AllowPaging="True" PagerSettings-Position="TopAndBottom" ShowHeaderWhenEmpty="True"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="KODE_DEPT" HeaderText="Kode Departemen" />
                            <asp:BoundField DataField="DEPT" HeaderText="Departemen" />
                            <asp:BoundField DataField="KET" HeaderText="KET" />
