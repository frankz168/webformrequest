<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="L_FormRequestGDR.aspx.cs" MasterPageFile="~/Site.Master" Inherits="WebDelamiFormRequest.Forms_Data.L_FormRequestGDR" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="PanelMain" runat="server">
        <div>
            ...
            <asp:Button ID="btn_newgdr" runat="server" Text="New Form Request GDR" OnClick="btn_newgdr_Click" />
