...
{
    public partial class L_FormRequestGDR : System.Web.UI.Page
    {
        ...
        public void LoadDataUser()
        {
            ...
            label_headdepartment2value.Text = HfUsername2.Value;
            ...
            if (Ds.Tables[0].Rows.Count > 0)
            {
                ...
                Session["ID_DEPT"] = Convert.ToString(Ds.Tables[0].Rows[0]["ID"].ToString());
        ...
        {
            Response.Redirect("~/Forms_Data/I_FormRequestGDR.aspx");
        }
    }
}