...
{
    public partial class L_FormRequest_Repair : System.Web.UI.Page
    {
        ...
        protected void gvMainRowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName.ToLower() != "page")
                {
                    ...
                    if (e.CommandName == "ClickRow")
                    {
                        ...
                        Response.Redirect("~/Forms_Data_Process/I_FormRequest_Repair.aspx?NO_FORM=" + HfNO_FORM.Value);
                    }
            ...
            catch (Exception ex)
            {
                ...
                //DiOthersessage.Attributes["class"] = "success";
        ...
        protected void btn_newrepair_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Forms_Data_Process/I_FormRequest_Repair.aspx");
        }
