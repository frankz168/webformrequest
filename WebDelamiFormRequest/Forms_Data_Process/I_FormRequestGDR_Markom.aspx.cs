...
{
    public partial class I_FormRequestGDR_Markom : System.Web.UI.Page
    {
        DataTable dt = new DataTable();
        DataTable dtToko = new DataTable();
        public string KODE_FORM = Common.KD_FORM_MARKOM;
        ...
        {
            Response.Redirect("L_FormRequestGDR_Markom.aspx");
        }
        ...
        protected void gvMain_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            string noform = Common.KD_FORM_MARKOM;
        ...
        public void LoadDataFormRequestGDR()
        {
            try
            {
                ...
                TR_FORM2_GDR_DA TrForm2Gdr = new DataLayer.TR_FORM2_GDR_DA();

                Ds = TrForm2Gdr.GetDataByKey(HfNO_FORM.Value);
                ...
                if (Ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (Ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        else if (URUTAN == 4)
                        {
                            ...
                            ShowButtonUrutan4();
                            if (Status == EApprovalStatus.ApprovedBMPhoto)
                            {
                        ...
                        else if (URUTAN == 6)
                        {
                            ...
                            ShowButtonUrutan6();
                            if (Status == EApprovalStatus.ApprovedCreativeManagerPG || Status == EApprovalStatus.ApprovedBMDI)
                            {
                                //ddlditerima2.Enabled = true;
                                btn_Approved.Enabled = true;
                                btn_ToRevise.Enabled = true;
                        ...
                        else if (URUTAN == 8)
                        {
                            ...
                            ShowButtonUrutan8();
                            if (Status == EApprovalStatus.ApprovedBM || Status == EApprovalStatus.ApprovedCreativeManagerDI)
                            {
                                ddlditerima2.Enabled = true;
        ...
        public void CreateNoFormGDR()
        {
            try
            {
                ...
                Ds = TrForm2Gdr.GetDataFilter(where);
        ...
        public void LoadStatusVer()
        {
            try
            {
                ...
                Ds = TrForm2Gdr.GetDataByKey(NO_FORM);
                if (Ds.Tables[0].Rows.Count > 0)
                {
        ...
        public void SaveFormRequestGDR()
        {
            try
            {
                ...
                string NO_FORM = text_noform.Text;
                string KODE_FORM = Common.KD_FORM_MARKOM;
                ...
                if (checkbox_digitaladvertising.Checked == true || checkbox_mediacetak.Checked == true || checkbox_other.Checked == true || checkbox_others1Markom.Checked == true || checkbox_socialmedia.Checked == true)
                {
                    if (DateTime.TryParse(text_tanggalrequired.Text, out temp))
                    {
                        ...
                        if (result > 0)
                        {
                            ...
                            else if (JENIS == "DEALERS" || JENIS == "NO_STORE")
                            {
                                totalgridjenis = 1;
                            }
                            ...
                            if (totalgridjenis == 1)
                            {
                                ...
                                if (i != 0)
                                {
                                    ...
                                    TR_FORM2_GDR TrForm2gdr = new TR_FORM2_GDR();
                                    TrForm2gdr.NO_FORM = NO_FORM;
                                    TrForm2gdr.KODE_FORM = KODE_FORM;
                                    TrForm2gdr.PERMINTAAN_DESIGN = PERMINTAAN_DESIGN;
                                    TrForm2gdr.JENIS = JENIS;
                                    TrForm2gdr.TGL_REQUEST = TGL_REQUEST;
                                    TrForm2gdr.TGL_REQUIRED = TGL_REQUIRED;
                                    TrForm2gdr.ID_DEPT = ID_DEPT;
                              ...
                              .SaveAs(Server.MapPath("~/Uploaded/FileUpload/") + RFR_LAMPIRAN1);
                                    ...
                                    TrForm2gdr.JADWAL_PRODUKSI_CETAK = Convert.ToDateTime(JADWAL_PRODUKSI_CETAK);
                                    TrForm2gdr.JADWAL_KIRIM = Convert.ToDateTime(JADWAL_KIRIM);
                                    TrForm2gdr.JADWAL_FOTO = Convert.ToDateTime(JADWAL_FOTO);
                                    TrForm2gdr.JADWAL_DI = Convert.ToDateTime(JADWAL_DI);
                                    TrForm2gdr.JADWAL_ADM_CREATIVE = Convert.ToDateTime(JADWAL_ADM_CREATIVE);
                                    TrForm2gdr.DIBUAT = DIBUAT;
                                    TrForm2gdr.TGL_DIBUAT = TGL_DIBUAT;
                                    TrForm2gdr.MENYETUJUI1 = "";
                                    TrForm2gdr.TGL_MENYETUJUI1 = startdate;
                                    TrForm2gdr.MENYETUJUI2 = "";
                                    TrForm2gdr.TGL_MENYETUJUI2 = startdate;
                                    TrForm2gdr.DITERIMA_1 = "";
                                    TrForm2gdr.TGL_DITERIMA_1 = startdate;
                                    TrForm2gdr.DITERIMA_2 = "";
                                    TrForm2gdr.TGL_DITERIMA_2 = startdate;
                                    TrForm2gdr.DITERIMA_3 = "";
                                    TrForm2gdr.TGL_DITERIMA_3 = startdate;
                                    TrForm2gdr.DITERIMA_LAIN_1 = "";
                                    TrForm2gdr.TGL_DITERIMA_LAIN_1 = startdate;
                                    TrForm2gdr.DITERIMA_LAIN_2 = "";
                                    TrForm2gdr.TGL_DITERIMA_LAIN_2 = startdate;
                                    TrForm2gdr.DITERIMA_LAIN_3 = "";
                                    TrForm2gdr.TGL_DITERIMA_LAIN_3 = startdate;
                                    TrForm2gdr.DITERIMA_LAIN_4 = "";
                                    TrForm2gdr.TGL_DITERIMA_LAIN_4 = startdate;
                                    TrForm2gdr.DITERIMA_LAIN_5_MATERI = "";
                                    TrForm2gdr.TGL_DITERIMA_LAIN_5_MATERI = startdate;
                                    TrForm2gdr.DITERIMA_LAIN_5 = "";
                                    TrForm2gdr.TGL_DITERIMA_LAIN_5 = startdate;
                                    TrForm2gdr.STATUS = EApprovalStatus.OnApprovedHD;
                                    TrForm2gdr.REVISI = "";
                                    ...
                                    TrForm2gdr.USER_CURRENT = DIBUAT;
                                    TrForm2gdr.NEXT_USER = USERNEXT;
                                    TrForm2gdr.URUTAN_USER_CURRENT = URUTAN;
                                    TrForm2gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                                    string PHOTOGRAPHER = "";
                                    //Check Photographer Yes / No
                                    ...
                                    TrForm2gdr.PHOTOGRAPHER = PHOTOGRAPHER;
                                    TrForm2gdr.DIGITAL_IMAGING = DigitalImaging;
                                    TrForm2gdr.PRODUCTION = PRODUCTION;
                                    TrForm2Gdr.Insert(TrForm2gdr);
                                    ...
                                    TrForm2gdractivity.KODE_FORM = Common.KD_FORM_MARKOM;
                                    TrForm2gdractivity.NO_FORM = NO_FORM;
                                    TrForm2gdractivity.STATUS = EApprovalStatus.OnApprovedHD;
                                    TrForm2gdractivity.DESCRIPTION = "Insert New Data. Status To " + EApprovalStatus.ApprovedHD;
                                    TrForm2gdractivity.REVISION = "-";
                                    TrForm2gdractivity.URUTAN = 1;
                                    TrForm2gdractivity.SP = "*";
                                    TrForm2gdractivity.USER_CURRENT = DIBUAT;
                                    ...
                                    string HomePageUrl = "../Forms_Data_Process/L_FormRequestGDR_Markom.aspx";
                                    Page.Header.Controls.Add(new LiteralControl(string.Format(@" <META http-equiv='REFRESH' content=3;url={0}> ", HomePageUrl)));
                                    //Response.Redirect("~/Forms_Data/L_FormRequestGDR_Markom.aspx");
                                }
                                else
                                {
        ...
        public void UpdateSubmitFormRequestGDR()
        {
            try
            {
                ...
                if (JENIS == "DEALERS" || JENIS == "NO_STORE")
                {
                    string Where = string.Format("KODE_FORM = '{0}' AND NO_FORM = '{1}'", KODE_FORM, NO_FORM);
                ...
                //      if (btn_uploadfilestore.HasFile)
                //      {
                //          int imgSize = btn_uploadfilestore.PostedFile.ContentLength;
                //          string ext = System.IO.Path.GetExtension(this.btn_uploadfilestore.PostedFile.FileName).ToLower();
                //          if (btn_uploadfilestore.PostedFile != null && btn_uploadfilestore.PostedFile.FileName != "")
                //          {


                //              if (btn_uploadfilestore.PostedFile.ContentLength > 3000000)
                //              {
                //                  DivMessage.InnerText = "File Store is larger than 3MB.";
                //                  DivMessage.Attributes["class"] = "error";
                //                  //DivMessage.Attributes["class"] = "success";
                //                  DivMessage.Visible = true;
                //                  return;
                ...
                //              else
                //              {
                //                  RFR_LAMPIRAN_STORE = text_noform.Text + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + "-" + "1" + btn_uploadfilestore.FileName;
                //                  btn_uploadfilestore.PostedFile
                //.SaveAs(Server.MapPath("~/Uploaded/FileUpload/") + RFR_LAMPIRAN_STORE);
                //              }
                //          }
                //      }
              ...
              .SaveAs(Server.MapPath("~/Uploaded/FileUpload/") + RFR_LAMPIRAN1);
                ...
                TrForm2gdractivity.NO_FORM = NO_FORM;
                TrForm2gdractivity.STATUS = EApprovalStatus.OnApprovedHD;
                TrForm2gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.OnRevise + " To " + EApprovalStatus.OnApprovedHD;
                TrForm2gdractivity.REVISION = "-";
                TrForm2gdractivity.URUTAN = 1;
                TrForm2gdractivity.SP = "";
                TrForm2gdractivity.USER_CURRENT = DIBUAT;
        ...
        public void UpdateSubmitFormRequestDesignGDR()
        {
            try
            {
              ...
              .SaveAs(Server.MapPath("~/Uploaded/FileUpload/") + RFR_LAMPIRAN1);
                ...
                TrForm2gdr.JADWAL_KIRIM = Convert.ToDateTime(JADWAL_KIRIM);
                TrForm2gdr.JADWAL_FOTO = Convert.ToDateTime(JADWAL_FOTO);
                TrForm2gdr.DITERIMA_2 = DITERIMA_2;
                TrForm2gdr.TGL_DITERIMA_2 = TGL_DITERIMA_2;
                TrForm2gdr.STATUS = EApprovalStatus.AcceptedGraphicDesign;
                TrForm2gdr.REVISI = "";
                ...
                //LoadStatusVer();
                //TrForm2gdr.STATUS_VER = HfStatusVer.Value + STATUS_VER;
                Int64 ID = 0;
                string ID_DEPT_USER = "";
                string USERNEXT = "";
                string DEPT_USER_NEXT = "";
                ...
                TrForm2gdr.USER_CURRENT = HfUsername.Value;
                TrForm2gdr.NEXT_USER = USERNEXT;
                TrForm2gdr.URUTAN_USER_CURRENT = URUTAN;
                TrForm2gdr.URUTAN_NEXT_USER = URUTAN_NEXT;

                TrForm2Gdr.UpdateDesign(TrForm2gdr);
                ...
                if (STATUS == EApprovalStatus.OnReviseDesign)
                {
                    ...
                    TrForm2gdractivity.KODE_FORM = Common.KD_FORM_MARKOM;
                    TrForm2gdractivity.NO_FORM = NO_FORM;
                    TrForm2gdractivity.STATUS = EApprovalStatus.AcceptedGraphicDesign;
                    TrForm2gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.OnReviseDesign + " To " + EApprovalStatus.AcceptedGraphicDesign;
                    TrForm2gdractivity.REVISION = "-";
                    TrForm2gdractivity.URUTAN = 10;
                    TrForm2gdractivity.SP = "*";
        ...
        public void UpdateSubmitFormRequestReviseContentGDR()
        {
            try
            {
                ...
                trform2gdr.JADWAL_DI = Convert.ToDateTime(JADWAL_DI);
                trform2gdr.JADWAL_ADM_CREATIVE = Convert.ToDateTime(JADWAL_ADM_CREATIVE);
                trform2gdr.DITERIMA_1 = DITERIMA_1;
                trform2gdr.TGL_DITERIMA_1 = TGL_DITERIMA_1;
                trform2gdr.DITERIMA_2 = DITERIMA_2;
                trform2gdr.STATUS = EApprovalStatus.OnReviseContent;
                trform2gdr.REVISI = REVISI;
                ...
                trform2gdr.URUTAN_USER_CURRENT = URUTAN;
                trform2gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                TrForm2Gdr.UpdateDiterima1RevisiContent(trform2gdr);
        ...
        public void UpdateStatusApproved()
        {
            try
            {
                ...
                TR_FORM2_GDR TrForm2gdr = new TR_FORM2_GDR();
                TrForm2gdr.NO_FORM = NO_FORM;
                TrForm2gdr.MENYETUJUI1 = MENYETUJUI1;
                TrForm2gdr.TGL_MENYETUJUI1 = TGL_MENYETUJUI1;
                TrForm2gdr.STATUS = EApprovalStatus.ApprovedHD;
                //TrForm2gdr.REVISI = "";
                ...
                TrForm2gdr.URUTAN_USER_CURRENT = URUTAN;
                TrForm2gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                TrForm2Gdr.UpdateMenyetujui1(TrForm2gdr);
                ...
                TrForm2gdractivity.KODE_FORM = Common.KD_FORM_MARKOM;
                TrForm2gdractivity.NO_FORM = NO_FORM;
                TrForm2gdractivity.STATUS = EApprovalStatus.ApprovedHD;
                TrForm2gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.OnApprovedHD + " To " + EApprovalStatus.ApprovedHD;
                TrForm2gdractivity.REVISION = "-";
                TrForm2gdractivity.URUTAN = 2;
                TrForm2gdractivity.SP = "";
                TrForm2gdractivity.USER_CURRENT = HfUsername.Value;
                TrForm2gdractivity.NEXT_USER = USERNEXT;
                TrForm2gdractivity.URUTAN_USER_CURRENT = URUTAN;
        ...
        public void UpdateStatusApprovedBM()
        {
            try
            {
                ...
                if (PHOTOGRAPHER == "Yes")
                {
                    STATUS = EApprovalStatus.ApprovedBMPhoto;
                    DESCRIPTION = "Update Status From " + EApprovalStatus.ApprovedHD + " To " + EApprovalStatus.ApprovedBMPhoto;
                ...
                {
                    STATUS = EApprovalStatus.ApprovedBMDI;
                    DESCRIPTION = "Update Status From " + EApprovalStatus.ApprovedHD + " To " + EApprovalStatus.ApprovedBMDI;
                ...
                {
                    STATUS = EApprovalStatus.ApprovedBM;
                    DESCRIPTION = "Update Status From " + EApprovalStatus.ApprovedHD + " To " + EApprovalStatus.ApprovedBM;
                ...
                TR_FORM2_GDR TrForm2gdr = new TR_FORM2_GDR();
                TrForm2gdr.NO_FORM = NO_FORM;
                TrForm2gdr.MENYETUJUI2 = MENYETUJUI2;
                TrForm2gdr.TGL_MENYETUJUI2 = TGL_MENYETUJUI2;
                TrForm2gdr.STATUS = STATUS;
                //TrForm2gdr.REVISI = "";
                TrForm2gdr.USER_CURRENT = HfUsername.Value;
                TrForm2gdr.NEXT_USER = USERNEXT;
                TrForm2gdr.URUTAN_USER_CURRENT = URUTAN;
                TrForm2gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                TrForm2Gdr.UpdateMenyetujui2(TrForm2gdr);
                ...
                TrForm2gdractivity.KODE_FORM = Common.KD_FORM_MARKOM;
                TrForm2gdractivity.NO_FORM = NO_FORM;
                TrForm2gdractivity.STATUS = STATUS;
                TrForm2gdractivity.DESCRIPTION = DESCRIPTION;
                TrForm2gdractivity.REVISION = "-";
                TrForm2gdractivity.URUTAN = 3;
                TrForm2gdractivity.SP = "";
                TrForm2gdractivity.USER_CURRENT = HfUsername.Value;
                TrForm2gdractivity.NEXT_USER = USERNEXT;
                TrForm2gdractivity.URUTAN_USER_CURRENT = URUTAN;
            ...
            try
            {
                ...
                if (REVISI != "")
                {
                    if (result > 0)
                    {
                        ...
                        TrForm2gdr.TGL_DITERIMA_1 = TGL_DITERIMA_1;
                        TrForm2gdr.DITERIMA_2 = DITERIMA_2;
                        TrForm2gdr.STATUS = EApprovalStatus.AcceptedHeadDesign;
                        TrForm2gdr.REVISI = REVISI;
                        ...
                        TrForm2gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                        TrForm2gdr.PRODUCTION = PRODUCTION;
                        TrForm2Gdr.UpdateDiterima1(TrForm2gdr);
                        ...
                        TrForm2gdractivity.KODE_FORM = Common.KD_FORM_MARKOM;
                        TrForm2gdractivity.NO_FORM = NO_FORM;
                        TrForm2gdractivity.STATUS = EApprovalStatus.AcceptedHeadDesign;
                        TrForm2gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.ApprovedBM + " To " + EApprovalStatus.AcceptedHeadDesign;
                        TrForm2gdractivity.REVISION = REVISI;
                        TrForm2gdractivity.URUTAN = 8;
                        TrForm2gdractivity.SP = "";
                        TrForm2gdractivity.USER_CURRENT = HfUsername.Value;
        ...
        public void UpdateStatusAcceptedGraphicDesign()
        {
            try
            {
                ...
                TrForm2gdr.URUTAN_USER_CURRENT = URUTAN;
                TrForm2gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                TrForm2Gdr.UpdateDiterima2(TrForm2gdr);
                ...
                TrForm2gdractivity.NO_FORM = NO_FORM;
                TrForm2gdractivity.STATUS = EApprovalStatus.AcceptedGraphicDesign;
                TrForm2gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.AcceptedHeadDesign + " To " + EApprovalStatus.AcceptedGraphicDesign;
                TrForm2gdractivity.REVISION = "-";
                TrForm2gdractivity.URUTAN = 9;
                TrForm2gdractivity.SP = "";
                TrForm2gdractivity.USER_CURRENT = HfUsername.Value;
                TrForm2gdractivity.NEXT_USER = USERNEXT;
                TrForm2gdractivity.URUTAN_USER_CURRENT = URUTAN;
        ...
        public void UpdateStatusApprovedCreativeManager()
        {
            try
            {
                ...
                if (PRODUCTION == EYesNo.Yes)
                {
                    ...
                    TR_FORM2_GDR TrForm2gdr = new TR_FORM2_GDR();
                    TrForm2gdr.NO_FORM = NO_FORM;
                    TrForm2gdr.DITERIMA_3 = DITERIMA_3;
                    TrForm2gdr.TGL_DITERIMA_3 = TGL_DITERIMA_3;
                    TrForm2gdr.STATUS = STATUS;
                    //TrForm2gdr.REVISI = "";
                    LoadStatusVer();
                    TrForm2gdr.STATUS_VER = HfStatusVer.Value + STATUS_VER;
                    ...
                    TrForm2gdr.URUTAN_USER_CURRENT = URUTAN;
                    TrForm2gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                    TrForm2Gdr.UpdateDiterima3(TrForm2gdr);
        ...
        public void UpdateStatusApprovedPhotographer()
        {
            try
            {
                ...
                TR_FORM2_GDR trform2gdr = new TR_FORM2_GDR();
                trform2gdr.NO_FORM = NO_FORM;
                trform2gdr.DITERIMA_LAIN_1 = DITERIMA_LAIN_1;
                trform2gdr.TGL_DITERIMA_LAIN_1 = TGL_DITERIMA_LAIN_1;
              ...
              .SaveAs(Server.MapPath("~/Uploaded/FileUploadPG/") + RFR_LAMPIRAN1_PG);
                ...
                if (DsUser.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        if (Status == EApprovalStatus.ApprovedBMPhoto || Status == EApprovalStatus.OnRevisePhoto)
                        {
                ...
                trform2gdr.URUTAN_USER_CURRENT = URUTAN;
                trform2gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                TrForm2Gdr.UpdateDiterimaLain1(trform2gdr);
                ...
                trform2gdractivity.KODE_FORM = Common.KD_FORM_MARKOM;
                trform2gdractivity.NO_FORM = NO_FORM;
                trform2gdractivity.STATUS = EApprovalStatus.ApprovedPhoto;
                trform2gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.ApprovedBMPhoto + " To " + EApprovalStatus.ApprovedPhoto;
                trform2gdractivity.REVISION = "-";
                trform2gdractivity.URUTAN = 4;
                trform2gdractivity.SP = "";
                trform2gdractivity.USER_CURRENT = HfUsername.Value;
                trform2gdractivity.NEXT_USER = USERNEXT;
                trform2gdractivity.URUTAN_USER_CURRENT = URUTAN;
        ...
        public void UpdateStatusApprovedCreativeManagerPhoto()
        {
            try
            {
                ...
                if (PHOTOGRAPHER == EYesNo.Yes && DIGITAL_IMAGING == EYesNo.Yes)
                {
                    TR_FORM2_GDR trform2gdr = new TR_FORM2_GDR();
                    trform2gdr.NO_FORM = NO_FORM;
                    trform2gdr.DITERIMA_LAIN_2 = DITERIMA_LAIN_2;
                    trform2gdr.TGL_DITERIMA_LAIN_2 = TGL_DITERIMA_LAIN_2;
                    trform2gdr.STATUS = EApprovalStatus.ApprovedCreativeManagerPG;
                    //trform2gdr.REVISI = "";
                    Int64 ID = 0;
                    string ID_DEPT_USER = "";
                    string USERNEXT = "";
                    ...
                    trform2gdr.URUTAN_USER_CURRENT = URUTAN;
                    trform2gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                    TrForm2Gdr.UpdateDiterimaLain2(trform2gdr);
                    ...
                    trform2gdractivity.KODE_FORM = Common.KD_FORM_MARKOM;
                    trform2gdractivity.NO_FORM = NO_FORM;
                    trform2gdractivity.STATUS = EApprovalStatus.ApprovedCreativeManagerPG;
                    trform2gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.ApprovedPhoto + " To " + EApprovalStatus.ApprovedCreativeManagerPG;
                    trform2gdractivity.REVISION = "-";
                    trform2gdractivity.URUTAN = 5;
                    trform2gdractivity.SP = "";
                    trform2gdractivity.USER_CURRENT = HfUsername.Value;
                    trform2gdractivity.NEXT_USER = USERNEXT;
                    trform2gdractivity.URUTAN_USER_CURRENT = URUTAN;
                ...
                else if (PHOTOGRAPHER == EYesNo.Yes && DIGITAL_IMAGING == EYesNo.No)
                {
                    ...
                    trform2gdr.DITERIMA_LAIN_2 = DITERIMA_LAIN_2;
                    trform2gdr.TGL_DITERIMA_LAIN_2 = TGL_DITERIMA_LAIN_2;
                    trform2gdr.STATUS = EApprovalStatus.Done;
                    //trform2gdr.REVISI = "";
                    Int64 ID = 0;
                    string ID_DEPT_USER = "";
                    string USERNEXT = "";
                    ...
                    trform2gdractivity.KODE_FORM = Common.KD_FORM_MARKOM;
                    trform2gdractivity.NO_FORM = NO_FORM;
                    trform2gdractivity.STATUS = EApprovalStatus.Done;
                    trform2gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.ApprovedPhoto + " To " + EApprovalStatus.Done;
                    trform2gdractivity.REVISION = "-";
                    trform2gdractivity.URUTAN = 5;
                    trform2gdractivity.SP = "";
                    trform2gdractivity.USER_CURRENT = HfUsername.Value;
        ...
        public void UpdateStatusApprovedDigitalImaging()
        {
            try
            {
                ...
                TR_FORM2_GDR trform2gdr = new TR_FORM2_GDR();
                trform2gdr.NO_FORM = NO_FORM;
                trform2gdr.DITERIMA_LAIN_3 = DITERIMA_LAIN_3;
                trform2gdr.TGL_DITERIMA_LAIN_3 = TGL_DITERIMA_LAIN_3;
              ...
              .SaveAs(Server.MapPath("~/Uploaded/FileUploadDI/") + RFR_LAMPIRAN1_DI);
                ...
                trform2gdr.URUTAN_USER_CURRENT = URUTAN;
                trform2gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                TrForm2Gdr.UpdateDiterimaLain3(trform2gdr);
                ...
                trform2gdractivity.KODE_FORM = Common.KD_FORM_MARKOM;
                trform2gdractivity.NO_FORM = NO_FORM;
                trform2gdractivity.STATUS = EApprovalStatus.ApprovedDI;
                trform2gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.ApprovedCreativeManagerPG + " To " + EApprovalStatus.ApprovedDI;
                trform2gdractivity.REVISION = "-";
                trform2gdractivity.URUTAN = 6;
                trform2gdractivity.SP = "";
                trform2gdractivity.USER_CURRENT = HfUsername.Value;
                trform2gdractivity.NEXT_USER = USERNEXT;
                trform2gdractivity.URUTAN_USER_CURRENT = URUTAN;
        ...
        public void UpdateStatusApprovedCreativeManagerDigitalImaging()
        {
            try
            {
                ...
                TR_FORM2_GDR trform2gdr = new TR_FORM2_GDR();
                trform2gdr.NO_FORM = NO_FORM;
                trform2gdr.DITERIMA_LAIN_4 = DITERIMA_LAIN_4;
                trform2gdr.TGL_DITERIMA_LAIN_4 = TGL_DITERIMA_LAIN_4;
                trform2gdr.STATUS = EApprovalStatus.ApprovedCreativeManagerDI;
                //trform2gdr.REVISI = "";
                Int64 ID = 0;
                string ID_DEPT_USER = "";
                string USERNEXT = "";
                ...
                trform2gdr.URUTAN_USER_CURRENT = URUTAN;
                trform2gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                TrForm2Gdr.UpdateDiterimaLain4(trform2gdr);
                ...
                trform2gdractivity.KODE_FORM = Common.KD_FORM_MARKOM;
                trform2gdractivity.NO_FORM = NO_FORM;
                trform2gdractivity.STATUS = EApprovalStatus.ApprovedCreativeManagerDI;
                trform2gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.ApprovedDI + " To " + EApprovalStatus.ApprovedCreativeManagerDI;
                trform2gdractivity.REVISION = "-";
        ...
        public void UpdateStatusApprovedProductionCetakMateri()
        {
            try
            {
                ...
                TR_FORM2_GDR trform2gdr = new TR_FORM2_GDR();
                trform2gdr.NO_FORM = NO_FORM;
                trform2gdr.DITERIMA_LAIN_5_MATERI = DITERIMA_LAIN_5_MATERI;
                trform2gdr.TGL_DITERIMA_LAIN_5_MATERI = TGL_DITERIMA_LAIN_5_MATERI;
                trform2gdr.STATUS = EApprovalStatus.DoneProductionCetakMateri;
                //trform2gdr.REVISI = "";
                Int64 ID = 0;
                string ID_DEPT_USER = "";
                string USERNEXT = "";
                ...
                trform2gdr.URUTAN_USER_CURRENT = URUTAN;
                trform2gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                TrForm2Gdr.UpdateDiterimaLain5Materi(trform2gdr);
                ...
                trform2gdractivity.KODE_FORM = Common.KD_FORM_MARKOM;
                trform2gdractivity.NO_FORM = NO_FORM;
                trform2gdractivity.STATUS = EApprovalStatus.DoneProductionCetakMateri;
                trform2gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.DoneProduction + " To " + EApprovalStatus.DoneProductionCetakMateri;
                trform2gdractivity.REVISION = "-";
                trform2gdractivity.URUTAN = 11;
                trform2gdractivity.SP = "";
                trform2gdractivity.USER_CURRENT = HfUsername.Value;
                trform2gdractivity.NEXT_USER = USERNEXT;
                trform2gdractivity.URUTAN_USER_CURRENT = URUTAN;
                ...
                DivMessage.InnerText = "Data Successfully Approved Produced in Material Printing";
                DivMessage.Style.Add("color", "black");
                DivMessage.Style.Add("background-color", "skyblue");
                DivMessage.Attributes["class"] = "error";
                //DivMessage.Attributes["class"] = "success";
        ...
        public void UpdateStatusApprovedProduction()
        {
            try
            {
                ...
                TR_FORM2_GDR trform2gdr = new TR_FORM2_GDR();
                trform2gdr.NO_FORM = NO_FORM;
                trform2gdr.DITERIMA_LAIN_5 = DITERIMA_LAIN_5;
                trform2gdr.TGL_DITERIMA_LAIN_5 = TGL_DITERIMA_LAIN_5;
                trform2gdr.STATUS = EApprovalStatus.DeliveredDistribution;
                //trform2gdr.REVISI = "";
                Int64 ID = 0;
                string ID_DEPT_USER = "";
                string USERNEXT = "";
                ...
                trform2gdr.URUTAN_USER_CURRENT = URUTAN;
                trform2gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                TrForm2Gdr.UpdateDiterimaLain5(trform2gdr);
                ...
                trform2gdractivity.KODE_FORM = Common.KD_FORM_MARKOM;
                trform2gdractivity.NO_FORM = NO_FORM;
                trform2gdractivity.STATUS = EApprovalStatus.DeliveredDistribution;
                trform2gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.DoneProductionCetakMateri + " To " + EApprovalStatus.DeliveredDistribution;
                trform2gdractivity.REVISION = "-";
                trform2gdractivity.URUTAN = 11;
                trform2gdractivity.SP = "";
                trform2gdractivity.USER_CURRENT = HfUsername.Value;
                ...
                DivMessage.InnerText = "Data Successfully Produced";
                DivMessage.Style.Add("color", "black");
                DivMessage.Style.Add("background-color", "skyblue");
                DivMessage.Attributes["class"] = "error";
                //DivMessage.Attributes["class"] = "success";
        ...
        public void UpdateStatusCancel()
        {
            try
            {
                ...
                TrForm2gdr.DIBUAT = DIBUAT;
                TrForm2gdr.TGL_DIBUAT = TGL_DIBUAT;
                TrForm2gdr.STATUS = EApprovalStatus.Cancel;
                //TrForm2gdr.REVISI = "";
                TrForm2gdr.USER_CURRENT = HfUsername.Value;
                TrForm2gdr.NEXT_USER = "-";
                TrForm2gdr.URUTAN_USER_CURRENT = 1;
                TrForm2gdr.URUTAN_NEXT_USER = 0;
                TrForm2Gdr.UpdateDibuat(TrForm2gdr);
                ...
                TrForm2gdractivity.KODE_FORM = Common.KD_FORM_MARKOM;
                TrForm2gdractivity.NO_FORM = NO_FORM;
                TrForm2gdractivity.STATUS = EApprovalStatus.Cancel;
                TrForm2gdractivity.DESCRIPTION = "Update Status To " + EApprovalStatus.Cancel;
                TrForm2gdractivity.REVISION = "-";
                TrForm2gdractivity.URUTAN = 1;
                TrForm2gdractivity.SP = "";
                TrForm2gdractivity.USER_CURRENT = HfUsername.Value;
                TrForm2gdractivity.NEXT_USER = "-";
                TrForm2gdractivity.URUTAN_USER_CURRENT = 1;
                TrForm2gdractivity.URUTAN_NEXT_USER = 0;
                TrForm2GdrActivity.Insert(TrForm2gdractivity);
        ...
        public void UpdateStatusCancelHeadDesign()
        {
            try
            {
                ...
                TrForm2gdr.TGL_DITERIMA_1 = TGL_DITERIMA_1;
                TrForm2gdr.STATUS = EApprovalStatus.Cancel;
                TrForm2gdr.REVISI = text_commentar.Text;
                TrForm2gdr.USER_CURRENT = HfUsername.Value;
                TrForm2gdr.NEXT_USER = "-";
                TrForm2gdr.URUTAN_USER_CURRENT = 1;
                TrForm2gdr.URUTAN_NEXT_USER = 0;
                TrForm2Gdr.UpdateDiterima1NonJadwal(TrForm2gdr);
                ...
                TrForm2gdractivity.STATUS = EApprovalStatus.Cancel;
                TrForm2gdractivity.DESCRIPTION = "Update Status To " + EApprovalStatus.Cancel;
                TrForm2gdractivity.REVISION = text_commentar.Text;
                TrForm2gdractivity.URUTAN = 8;
                TrForm2gdractivity.SP = "";
                TrForm2gdractivity.USER_CURRENT = HfUsername.Value;
                TrForm2gdractivity.NEXT_USER = "-";
        ...
        public void UpdateStatusCancelPhotographer()
        {
            try
            {
                ...
                TrForm2gdr.TGL_DITERIMA_LAIN_1 = TGL_DITERIMA_LAIN_1;
                TrForm2gdr.STATUS = EApprovalStatus.Cancel;
                TrForm2gdr.REVISI = KOMENTAR;
                TrForm2gdr.USER_CURRENT = HfUsername.Value;
                TrForm2gdr.NEXT_USER = "-";
                TrForm2gdr.URUTAN_USER_CURRENT = 4;
                TrForm2gdr.URUTAN_NEXT_USER = 0;
                TrForm2Gdr.UpdateCancelDiterimaLain1(TrForm2gdr);
                ...
                TrForm2gdractivity.STATUS = EApprovalStatus.Cancel;
                TrForm2gdractivity.DESCRIPTION = "Update Status To " + EApprovalStatus.Cancel;
                TrForm2gdractivity.REVISION = KOMENTAR;
                TrForm2gdractivity.URUTAN = 4;
                TrForm2gdractivity.SP = "";
                TrForm2gdractivity.USER_CURRENT = HfUsername.Value;
                TrForm2gdractivity.NEXT_USER = "-";
                TrForm2gdractivity.URUTAN_USER_CURRENT = 4;
                TrForm2gdractivity.URUTAN_NEXT_USER = 0;
                TrForm2GdrActivity.Insert(TrForm2gdractivity);
        ...
        public void UpdateStatusCancelDigitalImaging()
        {
            try
            {
                ...
                TrForm2gdr.USER_CURRENT = HfUsername.Value;
                TrForm2gdr.NEXT_USER = "-";
                TrForm2gdr.URUTAN_USER_CURRENT = 6;
                TrForm2gdr.URUTAN_NEXT_USER = 0;
                TrForm2Gdr.UpdateCancelDiterimaLain3(TrForm2gdr);
                ...
                TrForm2gdractivity.USER_CURRENT = HfUsername.Value;
                TrForm2gdractivity.NEXT_USER = "-";
                TrForm2gdractivity.URUTAN_USER_CURRENT = 6;
                TrForm2gdractivity.URUTAN_NEXT_USER = 0;
                TrForm2GdrActivity.Insert(TrForm2gdractivity);
        ...
        public void UpdateStatusRevisiHD()
        {
            try
            {
                ...
                if (REVISI != "")
                {
                    ...
                    TrForm2gdr.MENYETUJUI1 = MENYETUJUI1;
                    TrForm2gdr.TGL_MENYETUJUI1 = TGL_MENYETUJUI1;
                    TrForm2gdr.STATUS = EApprovalStatus.OnRevise;
                    TrForm2gdr.REVISI = REVISI;
                    ...
                    TrForm2gdr.URUTAN_USER_CURRENT = URUTAN;
                    TrForm2gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                    TrForm2Gdr.UpdateRevisiMenyetujui1(TrForm2gdr);
                    ...
                    TrForm2gdractivity.KODE_FORM = Common.KD_FORM_MARKOM;
                    TrForm2gdractivity.NO_FORM = NO_FORM;
                    TrForm2gdractivity.STATUS = EApprovalStatus.OnRevise;
                    TrForm2gdractivity.DESCRIPTION = "Update Status To " + EApprovalStatus.OnRevise;
                    TrForm2gdractivity.REVISION = REVISI;
                    TrForm2gdractivity.URUTAN = 2;
                    TrForm2gdractivity.SP = "";
                    TrForm2gdractivity.USER_CURRENT = HfUsername.Value;
        ...
        public void UpdateStatusRevisiBM()
        {
            try
            {
                ...
                if (REVISI != "")
                {
                    ...
                    TrForm2gdr.URUTAN_USER_CURRENT = URUTAN;
                    TrForm2gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                    TrForm2Gdr.UpdateRevisiMenyetujui2(TrForm2gdr);
        ...
        public void UpdateStatusRevisiHeadDesign()
        {
            try
            {
                ...
                if (REVISI != "")
                {
                    ...
                    TrForm2gdr.URUTAN_USER_CURRENT = URUTAN;
                    TrForm2gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                    TrForm2Gdr.UpdateRevisiDiterima1(TrForm2gdr);
        ...
        public void UpdateStatusRevisiGraphicDesign()
        {
            try
            {
                ...
                if (REVISI != "")
                {
                    ...
                    TrForm2gdr.URUTAN_USER_CURRENT = URUTAN;
                    TrForm2gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                    TrForm2Gdr.UpdateRevisiDiterima2(TrForm2gdr);
        ...
        //        TrForm2gdr.STATUS = EApprovalStatus.OnRevise;
        //        TrForm2gdr.REVISI = REVISI;
        //        TrForm2Gdr.UpdateRevisiDiterima3(TrForm2gdr);
        ...
        public void UpdateStatusRevisiDesign()
        {
            try
            {
                ...
                if (REVISIDESIGN != "")
                {
                    ...
                    TrForm2gdr.DITERIMA_3 = DITERIMA_3;
                    TrForm2gdr.TGL_DITERIMA_3 = TGL_DITERIMA_3;
                    TrForm2gdr.STATUS = EApprovalStatus.OnReviseDesign;
                    TrForm2gdr.REVISI = REVISIDESIGN;
                    LoadStatusVer();
                    TrForm2gdr.STATUS_VER = HfStatusVer.Value + STATUS_VER;
                    Int64 ID = 0;
                    string ID_DEPT_USER = "";
                    ...
                    TrForm2gdractivity.KODE_FORM = Common.KD_FORM_MARKOM;
                    TrForm2gdractivity.NO_FORM = NO_FORM;
                    TrForm2gdractivity.STATUS = EApprovalStatus.OnReviseDesign;
                    TrForm2gdractivity.DESCRIPTION = "Update Status To " + EApprovalStatus.OnReviseDesign;
                    TrForm2gdractivity.REVISION = REVISIDESIGN;
                    TrForm2gdractivity.URUTAN = 6;
                    TrForm2gdractivity.SP = "";
                    TrForm2gdr.USER_CURRENT = HfUsername.Value;
                    TrForm2gdr.NEXT_USER = USERNEXT;
        ...
        public void UpdateStatusRevisiPhotographer()
        {
            try
            {
                ...
                if (REVISI != "")
                {
                    ...
                    trform2gdr.DITERIMA_LAIN_1 = DITERIMA_LAIN_1;
                    trform2gdr.TGL_DITERIMA_LAIN_1 = TGL_DITERIMA_LAIN_1;
                    trform2gdr.STATUS = EApprovalStatus.OnRevisePhoto;
                    trform2gdr.REVISI = REVISI;
                    ...
                    TrForm2Gdr.UpdateRevisiDiterimaLain1(trform2gdr);
                    ...
                    trform2gdractivity.KODE_FORM = Common.KD_FORM_MARKOM;
                    trform2gdractivity.NO_FORM = NO_FORM;
                    trform2gdractivity.STATUS = EApprovalStatus.OnRevisePhoto;
                    trform2gdractivity.DESCRIPTION = "Update Status To " + EApprovalStatus.OnRevisePhoto;
                    trform2gdractivity.REVISION = REVISI;
                    trform2gdractivity.URUTAN = 5;
                    trform2gdractivity.SP = "";
                    trform2gdractivity.USER_CURRENT = HfUsername.Value;
        ...
        public void UpdateStatusRevisiDigitalImaging()
        {
            try
            {
                ...
                if (REVISI != "")
                {
                    ...
                    trform2gdr.DITERIMA_LAIN_3 = DITERIMA_LAIN_3;
                    trform2gdr.TGL_DITERIMA_LAIN_3 = TGL_DITERIMA_LAIN_3;
                    trform2gdr.STATUS = EApprovalStatus.OnRevisePhotoDI;
                    trform2gdr.REVISI = REVISI;
                    ...
                    trform2gdr.URUTAN_USER_CURRENT = URUTAN;
                    trform2gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                    TrForm2Gdr.UpdateRevisiDiterimaLain3(trform2gdr);
                    ...
                    trform2gdractivity.KODE_FORM = Common.KD_FORM_MARKOM;
                    trform2gdractivity.NO_FORM = NO_FORM;
                    trform2gdractivity.STATUS = EApprovalStatus.OnRevisePhotoDI;
                    trform2gdractivity.DESCRIPTION = "Update Status To " + EApprovalStatus.OnRevisePhotoDI;
                    trform2gdractivity.REVISION = REVISI;
                    trform2gdractivity.URUTAN = 7;
                    trform2gdractivity.SP = "";
                    trform2gdractivity.USER_CURRENT = HfUsername.Value;
        ...
        /// <summary>
        /// Add Data Detail TR_FORM2_GDR_KATEGORI
        /// </summary>
        /// 
        ...
        public void LoadDataDetailKategoriPermintaan()
        {
            try
            {
                TR_FORM2_GDR_KATEGORI_DA TrForm2GdrKategori = new DataLayer.TR_FORM2_GDR_KATEGORI_DA();
                DataSet Ds = new DataSet();
                ...
                Ds = TrForm2GdrKategori.GetDataFilter(Where);
                ...
                foreach (DataRow Item in Ds.Tables[0].Rows)
                {
                    ...
                    {
                        text_others1Markom.Text = DETAIL;
                        checkbox_others1Markom.Checked = true;
                    }
        ...
        public void GroupSaveKategoriPermintaan()
        {
            try
            {
                ...
                TR_FORM2_GDR_KATEGORI trform2gdrkategori = new TR_FORM2_GDR_KATEGORI();
                ...
                string other = "Other";
                string kodekategorimarkom = "KP-OTHERS";
                string other1Markom = text_others1Markom.Text;

                if (checkbox_socialmedia.Checked == true)
                {
                    trform2gdrkategori.NO_FORM = noform;
                    trform2gdrkategori.KODE_KATEGORI = kodekategori;
                    trform2gdrkategori.DETAIL = socialmedia;
                    trform2gdrkategori.ISPILIH = "Yes";
                    TrForm2GdrKategori.Insert(trform2gdrkategori);
                ...
                if (checkbox_mediacetak.Checked == true)
                {
                    trform2gdrkategori.NO_FORM = noform;
                    trform2gdrkategori.KODE_KATEGORI = kodekategori;
                    trform2gdrkategori.DETAIL = mediacetak;
                    trform2gdrkategori.ISPILIH = "Yes";
                    TrForm2GdrKategori.Insert(trform2gdrkategori);
                ...
                if (checkbox_digitaladvertising.Checked == true)
                {
                    trform2gdrkategori.NO_FORM = noform;
                    trform2gdrkategori.KODE_KATEGORI = kodekategori;
                    trform2gdrkategori.DETAIL = digitaladvertising;
                    trform2gdrkategori.ISPILIH = "Yes";
                    TrForm2GdrKategori.Insert(trform2gdrkategori);
                ...
                if (checkbox_other.Checked == true)
                {
                    trform2gdrkategori.NO_FORM = noform;
                    trform2gdrkategori.KODE_KATEGORI = kodekategori;
                    trform2gdrkategori.DETAIL = other;
                    trform2gdrkategori.ISPILIH = "Yes";
                    TrForm2GdrKategori.Insert(trform2gdrkategori);

                }

                if (checkbox_others1Markom.Checked == true)
                {
                    trform2gdrkategori.NO_FORM = noform;
                    trform2gdrkategori.KODE_KATEGORI = kodekategorimarkom;
                    trform2gdrkategori.DETAIL = other1Markom;
                    trform2gdrkategori.ISPILIH = "Yes";
                    TrForm2GdrKategori.Insert(trform2gdrkategori);
        ...
        public void GroupUpdateKategoriPermintaan()
        {
            try
            {
                ...
                TrForm2GdrKategori.DeleteFilter(Where);
        ...
        public void LoadDataDetailCustCt()
        {
            try
            {
                ...
                string Where = string.Format("KODE_FORM = 'FRM-0002' AND NO_FORM = '{0}'", NO_FORM);
        ...
        /// <summary>
        /// Add Data Pop Up Detail TR_FORM2_GDR_MATERI
        /// </summary>
        ...
        public void LoadDataDetailMateri()
        {
            try
            {
                TR_FORM2_GDR_MATERI_DA TrForm2GdrMateri = new DataLayer.TR_FORM2_GDR_MATERI_DA();
                DataSet Ds = new DataSet();
                ...
                Ds = TrForm2GdrMateri.GetDataFilter(Where);
        ...
        public void SaveDetailMateriCetak()
        {
            try
            {
                ...
                foreach (GridViewRow Item in gvMain.Rows)
                {
                    ...
                    TR_FORM2_GDR_MATERI TrForm2gdrmateri = new TR_FORM2_GDR_MATERI();
                    //TrForm2gdrmateri.ID_MATERI = ID_MATERI;
                    TrForm2gdrmateri.NO_FORM = NO_FORM;
                    TrForm2gdrmateri.site = site;
                    TrForm2gdrmateri.nama_cust = nama_cust;
                    TrForm2gdrmateri.JENIS_MATERIAL_CETAK = JENIS_MATERIAL_CETAK;
                    TrForm2gdrmateri.UKURAN = UKURAN;
                    TrForm2gdrmateri.MATERIAL = MATERIAL;
                    TrForm2gdrmateri.JUMLAH_QTY = Convert.ToDecimal(JUMLAH_QTY);
                    TrForm2gdrmateri.PENJELASAN = PENJELASAN;
                    TrForm2GdrMateri.Insert(TrForm2gdrmateri);
        ...
        public void UpdateDetailMateriCetak()
        {
            try
            {
                ...
                TrForm2GdrMateri.DeleteFilter(Where);
                SaveDetailMateriCetak();
        ...
        public void SendEmailAllType()
        {
            ...
            {
                DataSet DsForm = new DataSet();
                TR_FORM2_GDR_DA TrForm2DA = new TR_FORM2_GDR_DA();

                //Mendapatkan Status Form Berdasarkan No Form
                string NO_FORM = text_noform.Text;
                string Status = "";
                DsForm = TrForm2DA.GetDataByKey(NO_FORM);
                ...
                if (DsForm.Tables[0].Rows.Count > 0)
                {
                    ...
                    switch (Status)
                    {
                        case "Submit":
                            ...
                            //SendEmailApprovedBMToHeadDesign();
                            break;
                        ...
                        case "Approved-Brand-Manager":
                            SendEmailApprovedBMToHeadDesign();
                            break;
                        case "Approved-Brand-Manager-Photo":
                            SendEmailApprovedBMToPhoto();
                            break;
                        case "Approved-Brand-Manager-DI":
                            SendEmailApprovedBMToDI();
                            break;
                        case "Approved-Photo":
        ...
        public void SendEmailApprovedBMToHeadDesign()
        {
            try
            {
                string Dept = label_departmentvalue.Text;
        ...
        public void SendEmailApprovedBMToPhoto()
        {
            try
            {
                string Dept = label_departmentvalue.Text;
        ...
        public void SendEmailApprovedBMToDI()
        {
            try
            {
                string Dept = label_departmentvalue.Text;
            ...
            try
            {
                ...
                if (Ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (DsHeadDepartment.Tables[0].Rows.Count > 0)
                    {
                        ...
                        string EmailTemplateEng = "Dear Head Department,<br />" + MENYETUJUI_1 + "<br /><br />Terkait atas pengajuan dokumen berikut: <br />No Dokumen: " + NO_FORM + "<br />Jenis Form:  " + FORM_TYPE + "<br/>Brand: " + BRAND + "<br/>PIC: " + DIBUAT + "<br/>Request Date: " + TGL_REQUEST + "<br/>Required Date: " + TGL_REQUIRED + "<br/>Telah Dilakukan Revisi oleh: " + HfUsername.Value + "<br/>Mohon konfirmasinya dengan melakukan klik <br/> {0}<br /><br /><br />Regards,<br /><b>Automatic Delami Sender</b>";
