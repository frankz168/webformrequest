<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="I_FormRequestGDR_Others.aspx.cs" MasterPageFile="~/Site.Master" Inherits="WebDelamiFormRequest.Forms_Data_Process.I_FormRequestGDR_Others" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="PanelMain" runat="server">
        <div>
            ...
            <br />
            <h1>FORM REQUEST GRAFIS - GRAPHIC DESIGN (GDR) - OTHERS</h1>
            <hr />
            ...
            <table>
                ...
                <asp:Panel ID="Pnl_KategoriPermintaan" runat="server" Visible="true">
                    <tr>
                        ...
                        <td class="FV270">
                            <asp:CheckBox ID="checkbox_poster" runat="server" Text="" Font-Size="xx-Small" GroupName="KP" />
                            <asp:Label ID="label_poster" runat="server" Text="Poster" Font-Size="Small"></asp:Label>
                        </td>
                        <td class="FV270">
                            <asp:CheckBox ID="checkbox_others1Others" runat="server" Text="" Font-Size="XX-Small" />
                            <asp:TextBox ID="text_others1Others" runat="server" Text="" Font-Size="Small" Width="130px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="FN150"></td>
                        <td class="FV270">
                            <asp:CheckBox ID="checkbox_lighboxposter" runat="server" Text="" Font-Size="xx-Small" GroupName="KP" />
                            <asp:Label ID="label_lighboxposter" runat="server" Text="Lighbox Poster" Font-Size="Small"></asp:Label>
                        </td>
                        <td class="FV270">
                            <asp:CheckBox ID="checkbox_others2Others" runat="server" Text="" Font-Size="XX-Small" />
                            <asp:TextBox ID="text_others2Others" runat="server" Text="" Font-Size="Small" Width="130px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="FN150"></td>
                        <td class="FV270">
                            <asp:CheckBox ID="checkbox_hording" runat="server" Text="" Font-Size="xx-Small" GroupName="KP" />
                            <asp:Label ID="label_hording" runat="server" Text="Hording" Font-Size="Small"></asp:Label>
                        </td>
                        <td class="FV370">
                            <asp:CheckBox ID="checkbox_others3Others" runat="server" Text="" Font-Size="XX-Small" />
                            <asp:TextBox ID="text_others3Others" runat="server" Text="" Font-Size="Small" Width="130px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="FN150"></td>
                ...
                <asp:Panel ID="Pnl_DigitalImagingSelect" runat="server" Visible="true">
                    <tr>
                        <td class="FN150">
                            <asp:Label ID="label_digitalimaging" runat="server" Text="Design Required Digital Imaging? : "></asp:Label>
                        </td>
                        <td class="FV270">
                ...
                <asp:Panel ID="Pnl_Production" runat="server" Visible="true">
                    <tr>
                        <td class="FN150">
                            <asp:Label ID="label_production" runat="server" Text="Materi Printed Or No? : "></asp:Label>
                        </td>
                        <td class="FV270">
                    ...
                    <tr>
                        ...
                        <td class="FV270">
                            <asp:DropDownList ID="ddljenis" runat="server" Width="206px" Height="30px" AutoPostBack="true" OnSelectedIndexChanged="ddljenis_SelectedIndexChanged1">
                                ...
                                <asp:ListItem Text="Internal Department" Value="INTERNAL_DEPARTMENT" Selected="True" />
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="FV270">
                            ...
                            <asp:Button ID="btnFilenameStoreClear" runat="server" Text="Clear" OnClick="btnFilenameStoreClear_Click" PostBackUrl="~/Forms_Data_Process/I_FormRequestGDR_Others.aspx"></asp:Button>
                        </td>
                    </tr>
                    <tr>
                        <td class="FN150">
                        ...
                        <td class="FV270" colspan="3">
                            <div class="EU_TableScrollCustom" style="display: block; max-height: 800px;">
                                ...
                                <asp:SqlDataSource ID="C_Grid" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                                    SelectCommand="SELECT * FROM TR_FORM3_GDR_MATERI"></asp:SqlDataSource>
                            </div>
                        </td>
                    </tr>
                    <tr>
    ...
    <asp:Panel ID="PanelReviseDesign" runat="server" BackColor="WhiteSmoke" CssClass="ModalWindow"
        ...
        <table>
            <asp:Panel ID="Pnl_RevisiDesign" runat="server" Visible="true">
                <tr>
                    <td class="FN150">
                        <asp:Label ID="label_revisidesign" runat="server" Text="Revise Design: " Width="170px"></asp:Label>
                    </td>
                    <td class="FV270">
