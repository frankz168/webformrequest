...
{
    public partial class I_FormRequestGDR_VM : System.Web.UI.Page
    {
        DataTable dt = new DataTable();
        DataTable dtToko = new DataTable();
        public string KODE_FORM = Common.KD_FORM_VM;
        ...
        {
            Response.Redirect("L_FormRequestGDR_VM.aspx");
        }
        ...
        protected void gvMain_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            string noform = Common.KD_FORM_VM;
        ...
        public void LoadDataFormRequestGDR()
        {
            try
            {
                ...
                if (Ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (text_tanggalmenyetujui2.Text == "1900-01-01")
                    {
                        text_tanggalmenyetujui2.Text = "";
                    }
                    text_menyetujui3.Text = Convert.ToString(Ds.Tables[0].Rows[0]["MENYETUJUI3"].ToString());
                    text_tanggalmenyetujui3.Text = DateTime.Parse(Ds.Tables[0].Rows[0]["TGL_MENYETUJUI3"].ToString()).ToString("yyyy-MM-dd");
                    if (text_tanggalmenyetujui3.Text == "1900-01-01")
                    {
                        text_tanggalmenyetujui3.Text = "";
                    }
                    ...
                    if (Ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        {
                            text_menyetujui3.Text = HfUsername.Value;
                            ShowButtonUrutan4();
                        ...
                        else if (URUTAN == 5)
                        {
                            ...
                            ShowButtonUrutan5();
                            if (Status == EApprovalStatus.ApprovedHDVMPhoto)
                            {
                                //ddlditerima2.Enabled = true;
                                btn_Approved.Enabled = true;
                                btn_ToRevise.Enabled = true;
                        ...
                        else if (URUTAN == 7)
                        {
                            ...
                            ShowButtonUrutan7();
                            if (Status == EApprovalStatus.ApprovedCreativeManagerPG || Status == EApprovalStatus.ApprovedHDVMDI)
                            {
                                //ddlditerima2.Enabled = true;
                                btn_Approved.Enabled = true;
                                btn_ToRevise.Enabled = true;
                        ...
                        else if (URUTAN == 9)
                        {
                            ...
                            ShowButtonUrutan9();
                            if (Status == EApprovalStatus.ApprovedHDVM || Status == EApprovalStatus.ApprovedCreativeManagerDI)
                            {
                                ddlditerima2.Enabled = true;
        ...
        public void LoadStatusVer()
        {
            try
            {
                ...
                Ds = TrForm1Gdr.GetDataByKey(NO_FORM);
                if (Ds.Tables[0].Rows.Count > 0)
                {
        ...
        public void SaveFormRequestGDR()
        {
            try
            {
                ...
                string NO_FORM = text_noform.Text;
                string KODE_FORM = Common.KD_FORM_VM;
                ...
                File2MB = SizeFile1 * SizeFile2;

                if (checkbox_POPHighlightA1.Checked == true || checkbox_POPHighlightA3.Checked == true || checkbox_POPHighlightA4.Checked == true || checkbox_POPHighlightA5.Checked == true || checkbox_POPHighlightA6.Checked == true || checkbox_POPregularA1.Checked == true || checkbox_POPregularA3.Checked == true || checkbox_POPregularA4.Checked == true || checkbox_POPregularA5.Checked == true || checkbox_POPregularA6.Checked == true || checkbox_windowtema.Checked == true || checkbox_others1VM.Checked == true)
                {
                        ...
                        if (result > 0)
                        {
                            ...
                            if (totalgridjenis == 1)
                            {
                                ...
                                if (i != 0)
                                {
                                    ...
                                    trform1gdr.RFR_LAMPIRAN_STORE = RFR_LAMPIRAN_STORE;
                                    trform1gdr.RFR_LAMPIRAN_MATERIAL = RFR_LAMPIRAN_MATERIAL;
                              ...
                              .SaveAs(Server.MapPath("~/Uploaded/FileUpload/") + RFR_LAMPIRAN1);
                                    ...
                                    trform1gdr.JADWAL_SELESAI_DESAIN = Convert.ToDateTime(JADWAL_SELESAI_DESAIN);
                                    trform1gdr.JADWAL_PRODUKSI_CETAK = Convert.ToDateTime(JADWAL_PRODUKSI_CETAK);
                                    trform1gdr.JADWAL_KIRIM = Convert.ToDateTime(JADWAL_KIRIM);
                                    trform1gdr.JADWAL_FOTO = Convert.ToDateTime(JADWAL_FOTO);
                                    trform1gdr.JADWAL_DI = Convert.ToDateTime(JADWAL_DI);
                                    trform1gdr.JADWAL_ADM_CREATIVE = Convert.ToDateTime(JADWAL_ADM_CREATIVE);
                                    ...
                                    trform1gdr.MENYETUJUI3 = "";
                                    trform1gdr.TGL_MENYETUJUI3 = startdate;
                                    ...
                                    trform1gdr.DITERIMA_LAIN_1 = "";
                                    trform1gdr.TGL_DITERIMA_LAIN_1 = startdate;
                                    trform1gdr.DITERIMA_LAIN_2 = "";
                                    trform1gdr.TGL_DITERIMA_LAIN_2 = startdate;
                                    trform1gdr.DITERIMA_LAIN_3 = "";
                                    trform1gdr.TGL_DITERIMA_LAIN_3 = startdate;
                                    trform1gdr.DITERIMA_LAIN_4 = "";
                                    trform1gdr.TGL_DITERIMA_LAIN_4 = startdate;
                                    trform1gdr.DITERIMA_LAIN_5 = "";
                                    trform1gdr.TGL_DITERIMA_LAIN_5 = startdate;
                                    trform1gdr.DITERIMA_LAIN_5_MATERI = "";
                                    trform1gdr.TGL_DITERIMA_LAIN_5_MATERI = startdate;
                                    trform1gdr.STATUS = EApprovalStatus.OnApprovedHD;
                                    trform1gdr.REVISI = "";
                                    ...
                                    trform1gdr.USER_CURRENT = DIBUAT;
                                    trform1gdr.NEXT_USER = USERNEXT;
                                    trform1gdr.URUTAN_USER_CURRENT = URUTAN;
                                    trform1gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                                    ...
                                    trform1gdr.PHOTOGRAPHER = PHOTOGRAPHER;
                                    trform1gdr.DIGITAL_IMAGING = DigitalImaging;
                                    trform1gdr.PRODUCTION = PRODUCTION;
                                    ...
                                    TR_FORM_GDR_ACTIVITY_DA TrForm1GdrActivity = new DataLayer.TR_FORM_GDR_ACTIVITY_DA();
                                    DataSet DsFormActivity = new DataSet();

                                    TR_FORM_GDR_ACTIVITY trform1gdractivity = new TR_FORM_GDR_ACTIVITY();
                                    trform1gdractivity.USERNAME = HfUsername.Value;
                                    trform1gdractivity.ACTIVITY_TIME = DateTime.Now;
                                    trform1gdractivity.KODE_FORM = Common.KD_FORM_VM;
                                    trform1gdractivity.NO_FORM = NO_FORM;
                                    trform1gdractivity.STATUS = EApprovalStatus.OnApprovedHD;
                                    trform1gdractivity.DESCRIPTION = "Insert New Data. Status To " + EApprovalStatus.ApprovedHD;
                                    trform1gdractivity.REVISION = "-";
                                    trform1gdractivity.URUTAN = 1;
                                    trform1gdractivity.SP = "*";
                                    trform1gdractivity.USER_CURRENT = DIBUAT;
                                    trform1gdractivity.NEXT_USER = USERNEXT;
                                    trform1gdractivity.URUTAN_USER_CURRENT = URUTAN;
                                    trform1gdractivity.URUTAN_NEXT_USER = URUTAN_NEXT;
                                    TrForm1GdrActivity.Insert(trform1gdractivity);
                                    ...
                                    string HomePageUrl = "../Forms_Data_Process/L_FormRequestGDR_VM.aspx";
        ...
        public void UpdateSubmitFormRequestGDR()
        {
            try
            {
              ...
              .SaveAs(Server.MapPath("~/Uploaded/FileUpload/") + RFR_LAMPIRAN1);
                ...
                trform1gdr.USER_CURRENT = HfUsername.Value;
                trform1gdr.NEXT_USER = USERNEXT;
                trform1gdr.URUTAN_USER_CURRENT = URUTAN;
                trform1gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                ...
                trform1gdractivity.NO_FORM = NO_FORM;
                trform1gdractivity.STATUS = EApprovalStatus.OnApprovedHD;
                trform1gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.OnRevise + " To " + EApprovalStatus.OnApprovedHD;
                trform1gdractivity.REVISION = "-";
                trform1gdractivity.URUTAN = 1;
                trform1gdractivity.SP = "";
                trform1gdractivity.USER_CURRENT = HfUsername.Value;
                trform1gdractivity.NEXT_USER = USERNEXT;
                trform1gdractivity.URUTAN_USER_CURRENT = URUTAN;
                trform1gdractivity.URUTAN_NEXT_USER = URUTAN_NEXT;
                TrForm1GdrActivity.Insert(trform1gdractivity);
        ...
        public void UpdateSubmitFormRequestDesignGDR()
        {
            try
            {
              ...
              .SaveAs(Server.MapPath("~/Uploaded/FileUpload/") + RFR_LAMPIRAN1);
                ...
                trform1gdr.RFR_LAMPIRAN8_GD = RFR_LAMPIRAN8GD;
                ...
                if (DsUser.Tables[0].Rows.Count > 0)
                {
                    ...
                    string ACTIONS = "Approved";
                    //Mendapatkan Urutan User Berdasarkan Jabatan User Next
                    DsUser = MsUserDA.GetDataUrutanUserCustom(USERNEXT, KODE_FORM, ACTIONS);
                ...
                trform1gdr.URUTAN_USER_CURRENT = URUTAN;
                trform1gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                TrForm1Gdr.UpdateDesign(trform1gdr);
                ...
                if (STATUS == EApprovalStatus.OnReviseDesign)
                {
                    ...
                    trform1gdractivity.KODE_FORM = Common.KD_FORM_VM;
                    trform1gdractivity.NO_FORM = NO_FORM;
                    trform1gdractivity.STATUS = EApprovalStatus.AcceptedGraphicDesign;
                    trform1gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.OnReviseDesign + " To " + EApprovalStatus.AcceptedGraphicDesign;
                    trform1gdractivity.REVISION = "-";
                    trform1gdractivity.URUTAN = 11;
                    trform1gdractivity.SP = "*";
                    trform1gdractivity.USER_CURRENT = HfUsername.Value;
                    trform1gdractivity.NEXT_USER = USERNEXT;
                    trform1gdractivity.URUTAN_USER_CURRENT = URUTAN;
        ...
        public void UpdateSubmitFormRequestReviseContentGDR()
        {
            try
            {
                ...
                trform1gdr.DITERIMA_2 = DITERIMA_2;
                trform1gdr.STATUS = EApprovalStatus.OnReviseContent;
                ...
                trform1gdr.URUTAN_USER_CURRENT = URUTAN;
                trform1gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                TrForm1Gdr.UpdateDiterima1RevisiContent(trform1gdr);
                ...
                trform1gdractivity.KODE_FORM = Common.KD_FORM_VM;
                trform1gdractivity.NO_FORM = NO_FORM;
                trform1gdractivity.STATUS = EApprovalStatus.OnReviseContent;
                trform1gdractivity.DESCRIPTION = "Update Status To " + EApprovalStatus.OnReviseContent;
                trform1gdractivity.REVISION = REVISI;
                trform1gdractivity.URUTAN = 9;
                trform1gdractivity.SP = "";
                trform1gdractivity.USER_CURRENT = HfUsername.Value;
                trform1gdractivity.NEXT_USER = USERNEXT;
                trform1gdractivity.URUTAN_USER_CURRENT = URUTAN;
                ...
                DivMessage.InnerText = "Data Successfully Revised Content";
                DivMessage.Style.Add("color", "black");
                DivMessage.Style.Add("background-color", "skyblue");
                DivMessage.Attributes["class"] = "error";
                //DivMessage.Attributes["class"] = "success";
                ...
                //else
                //{
                //    DivMessage.InnerText = "Commentar Cannot Be Empty";
                //    DivMessage.Attributes["class"] = "error";
                //    //DivMessage.Attributes["class"] = "success";
                //    DivMessage.Visible = true;
                //}
        ...
        public void UpdateStatusApproved()
        {
            try
            {
                ...
                trform1gdr.STATUS = EApprovalStatus.ApprovedHD;
                //trform1gdr.REVISI = "";
                ...
                trform1gdractivity.KODE_FORM = Common.KD_FORM_VM;
                trform1gdractivity.NO_FORM = NO_FORM;
                trform1gdractivity.STATUS = EApprovalStatus.ApprovedHD;
                trform1gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.OnApprovedHD + " To " + EApprovalStatus.ApprovedHD;
                trform1gdractivity.REVISION = "-";
                trform1gdractivity.URUTAN = 2;
                trform1gdractivity.SP = "";
                trform1gdractivity.USER_CURRENT = HfUsername.Value;
                trform1gdractivity.NEXT_USER = USERNEXT;
                trform1gdractivity.URUTAN_USER_CURRENT = URUTAN;
        ...
        public void UpdateStatusApprovedBM()
        {
            try
            {
                ...
                string Where = string.Format("KD_JABATAN = 'HDVM'");
                DsUser = MsUserDA.GetDataFilter(Where);
                ...
                trform1gdractivity.KODE_FORM = Common.KD_FORM_VM;
                trform1gdractivity.NO_FORM = NO_FORM;
                trform1gdractivity.STATUS = EApprovalStatus.ApprovedBM;
                trform1gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.ApprovedHD + " To " + EApprovalStatus.ApprovedBM;
                trform1gdractivity.REVISION = "-";
                trform1gdractivity.URUTAN = 3;
                trform1gdractivity.SP = "";
                trform1gdractivity.USER_CURRENT = HfUsername.Value;
                trform1gdractivity.NEXT_USER = USERNEXT;
                trform1gdractivity.URUTAN_USER_CURRENT = URUTAN;
        ...
        //Action Head VM
        public void UpdateStatusApprovedHeadVM()
        {
            try
            {
                TR_FORM1_GDR_DA TrForm1Gdr = new DataLayer.TR_FORM1_GDR_DA();
                ...
                string NO_FORM = text_noform.Text;
                string MENYETUJUI3 = text_menyetujui3.Text;
                DateTime TGL_MENYETUJUI3 = DateTime.Now;
                ...
                if (PHOTOGRAPHER == "Yes")
                {
                    STATUS = EApprovalStatus.ApprovedHDVMPhoto;
                    DESCRIPTION = "Update Status From " + EApprovalStatus.ApprovedBM + " To " + EApprovalStatus.ApprovedHDVMPhoto;
                ...
                {
                    STATUS = EApprovalStatus.ApprovedHDVMDI;
                    DESCRIPTION = "Update Status From " + EApprovalStatus.ApprovedBM + " To " + EApprovalStatus.ApprovedHDVMDI;
                ...
                {
                    STATUS = EApprovalStatus.ApprovedHDVM;
                    DESCRIPTION = "Update Status From " + EApprovalStatus.ApprovedBM + " To " + EApprovalStatus.ApprovedHDVM;
                ...
                TR_FORM1_GDR trform1gdr = new TR_FORM1_GDR();
                trform1gdr.NO_FORM = NO_FORM;
                trform1gdr.MENYETUJUI3 = MENYETUJUI3;
                trform1gdr.TGL_MENYETUJUI3 = TGL_MENYETUJUI3;
                trform1gdr.STATUS = STATUS;
                //trform1gdr.REVISI = ""; 
                trform1gdr.USER_CURRENT = HfUsername.Value;
                trform1gdr.NEXT_USER = USERNEXT;
                trform1gdr.URUTAN_USER_CURRENT = URUTAN;
                trform1gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                TrForm1Gdr.UpdateMenyetujui3(trform1gdr);
                ...
                trform1gdractivity.KODE_FORM = Common.KD_FORM_VM;
                trform1gdractivity.NO_FORM = NO_FORM;
                trform1gdractivity.STATUS = STATUS;
                trform1gdractivity.DESCRIPTION = DESCRIPTION;
                trform1gdractivity.REVISION = "-";
                trform1gdractivity.URUTAN = 4;
                trform1gdractivity.SP = "";
                trform1gdractivity.USER_CURRENT = HfUsername.Value;
                trform1gdractivity.NEXT_USER = USERNEXT;
                trform1gdractivity.URUTAN_USER_CURRENT = URUTAN;
                ...
                DivMessage.InnerText = "Data Successful Approved Head VM";
                DivMessage.Style.Add("color", "black");
                DivMessage.Style.Add("background-color", "skyblue");
                DivMessage.Attributes["class"] = "error";
                //DivMessage.Attributes["class"] = "success";
            ...
            try
            {
                ...
                if (REVISI != "")
                {
                    if (result > 0)
                    {
                        ...
                        trform1gdr.TGL_DITERIMA_1 = TGL_DITERIMA_1;
                        trform1gdr.DITERIMA_2 = DITERIMA_2;
                        trform1gdr.STATUS = EApprovalStatus.AcceptedHeadDesign;
                        //trform1gdr.REVISI = "";
                        Int64 ID = 0;
                        string ID_DEPT_USER = "";
                        string USERNEXT = "";
                        ...
                        trform1gdractivity.KODE_FORM = Common.KD_FORM_VM;
                        trform1gdractivity.NO_FORM = NO_FORM;
                        trform1gdractivity.STATUS = EApprovalStatus.AcceptedHeadDesign;
                        trform1gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.ApprovedHDVM + " To " + EApprovalStatus.AcceptedHeadDesign;
                        trform1gdractivity.REVISION = REVISI;
                        trform1gdractivity.URUTAN = 9;
                        trform1gdractivity.SP = "";
                        trform1gdractivity.USER_CURRENT = HfUsername.Value;
                    ...
                    {
                        DivMessage.InnerText = "Date of Design Schedule May Not Be Smaller Than Today's Date";
                        DivMessage.Attributes["class"] = "error";
                        //DivMessage.Attributes["class"] = "success";
                        DivMessage.Visible = true;
                    }
        ...
        public void UpdateStatusAcceptedGraphicDesign()
        {
            try
            {
                ...
                trform1gdractivity.NO_FORM = NO_FORM;
                trform1gdractivity.STATUS = EApprovalStatus.AcceptedGraphicDesign;
                trform1gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.AcceptedHeadDesign + " To " + EApprovalStatus.AcceptedGraphicDesign;
                trform1gdractivity.REVISION = "-";
                trform1gdractivity.URUTAN = 10;
                trform1gdractivity.SP = "*";
                trform1gdractivity.USER_CURRENT = HfUsername.Value;
                trform1gdractivity.NEXT_USER = USERNEXT;
                trform1gdractivity.URUTAN_USER_CURRENT = URUTAN;
        ...
        public void UpdateStatusApprovedCreativeManager()
        {
            try
            {
                ...
                if (PRODUCTION == EYesNo.Yes)
                {
                    ...
                    trform1gdr.STATUS = STATUS;
                    LoadStatusVer();
                    trform1gdr.STATUS_VER = HfStatusVer.Value + STATUS_VER;
                    //trform1gdr.REVISI = "";
                    Int64 ID = 0;
                    string ID_DEPT_USER = "";
                    string USERNEXT = "";
                    ...
                    string Where = string.Format("KD_JABATAN = 'PDC' AND USERNAME = 'PDC.VM'");
                    DsUser = MsUserDA.GetDataFilter(Where);
                ...
                DivMessage.InnerText = "Data Successful Approved Creative Manager";
                DivMessage.Style.Add("color", "black");
                DivMessage.Style.Add("background-color", "skyblue");
                DivMessage.Attributes["class"] = "error";
                //DivMessage.Attributes["class"] = "success";
        ...
        public void UpdateStatusApprovedPhotographer()
        {
            try
            {
                ...
                TR_FORM1_GDR trform1gdr = new TR_FORM1_GDR();
                trform1gdr.NO_FORM = NO_FORM;
                trform1gdr.DITERIMA_LAIN_1 = DITERIMA_LAIN_1;
              ...
              .SaveAs(Server.MapPath("~/Uploaded/FileUploadPG/") + RFR_LAMPIRAN1_PG);
                ...
                trform1gdr.RFR_LAMPIRAN4_PG = RFR_LAMPIRAN4_PG;
                ...
                if (DsUser.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        if (Status == EApprovalStatus.ApprovedHDVMPhoto || Status == EApprovalStatus.OnRevisePhoto)
                        {
                ...
                trform1gdr.URUTAN_USER_CURRENT = URUTAN;
                trform1gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                TrForm1Gdr.UpdateDiterimaLain1(trform1gdr);
                ...
                trform1gdractivity.KODE_FORM = Common.KD_FORM_VM;
                trform1gdractivity.NO_FORM = NO_FORM;
                trform1gdractivity.STATUS = EApprovalStatus.ApprovedPhoto;
                trform1gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.ApprovedHDVMPhoto + " To " + EApprovalStatus.ApprovedPhoto;
                trform1gdractivity.REVISION = "-";
                trform1gdractivity.URUTAN = 5;
                trform1gdractivity.SP = "";
                trform1gdractivity.USER_CURRENT = HfUsername.Value;
                trform1gdractivity.NEXT_USER = USERNEXT;
                trform1gdractivity.URUTAN_USER_CURRENT = URUTAN;
        ...
        public void UpdateStatusApprovedCreativeManagerPhoto()
        {
            try
            {
                ...
                if (PHOTOGRAPHER == EYesNo.Yes && DIGITAL_IMAGING == EYesNo.Yes)
                {
                    TR_FORM1_GDR trform1gdr = new TR_FORM1_GDR();
                    trform1gdr.NO_FORM = NO_FORM;
                    trform1gdr.DITERIMA_LAIN_2 = DITERIMA_LAIN_2;
                    trform1gdr.TGL_DITERIMA_LAIN_2 = TGL_DITERIMA_LAIN_2;
                    trform1gdr.STATUS = EApprovalStatus.ApprovedCreativeManagerPG;
                    //trform1gdr.REVISI = "";
                    Int64 ID = 0;
                    string ID_DEPT_USER = "";
                    string USERNEXT = "";
                    ...
                    trform1gdr.URUTAN_USER_CURRENT = URUTAN;
                    trform1gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                    TrForm1Gdr.UpdateDiterimaLain2(trform1gdr);
                    ...
                    trform1gdractivity.KODE_FORM = Common.KD_FORM_VM;
                    trform1gdractivity.NO_FORM = NO_FORM;
                    trform1gdractivity.STATUS = EApprovalStatus.ApprovedCreativeManagerPG;
                    trform1gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.ApprovedPhoto + " To " + EApprovalStatus.ApprovedCreativeManagerPG;
                    trform1gdractivity.REVISION = "-";
                    trform1gdractivity.URUTAN = 6;
                    trform1gdractivity.SP = "";
                    trform1gdractivity.USER_CURRENT = HfUsername.Value;
                    trform1gdractivity.NEXT_USER = USERNEXT;
                    trform1gdractivity.URUTAN_USER_CURRENT = URUTAN;
                    ...
                    DivMessage.InnerText = "Data Successful Di Creative Director-Foto";
                    DivMessage.Style.Add("color", "black");
                    DivMessage.Style.Add("background-color", "skyblue");
                    DivMessage.Attributes["class"] = "error";
                    //DivMessage.Attributes["class"] = "success";
                ...
                else if (PHOTOGRAPHER == EYesNo.Yes && DIGITAL_IMAGING == EYesNo.No)
                {
                    ...
                    trform1gdractivity.KODE_FORM = Common.KD_FORM_VM;
                    trform1gdractivity.NO_FORM = NO_FORM;
                    trform1gdractivity.STATUS = EApprovalStatus.Done;
                    trform1gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.ApprovedPhoto + " To " + EApprovalStatus.Done;
                    trform1gdractivity.REVISION = "-";
                    trform1gdractivity.URUTAN = 6;
                    trform1gdractivity.SP = "";
                    trform1gdractivity.USER_CURRENT = HfUsername.Value;
                    ...
                    DivMessage.InnerText = "Data Successful Di Creative Director-Foto (Done)";
                    DivMessage.Style.Add("color", "black");
                    DivMessage.Style.Add("background-color", "skyblue");
                    DivMessage.Attributes["class"] = "error";
                    //DivMessage.Attributes["class"] = "success";
        ...
        public void UpdateStatusApprovedDigitalImaging()
        {
            try
            {
                ...
                TR_FORM1_GDR trform1gdr = new TR_FORM1_GDR();
                trform1gdr.NO_FORM = NO_FORM;
                trform1gdr.DITERIMA_LAIN_3 = DITERIMA_LAIN_3;
                trform1gdr.TGL_DITERIMA_LAIN_3 = TGL_DITERIMA_LAIN_3;
              ...
              .SaveAs(Server.MapPath("~/Uploaded/FileUploadDI/") + RFR_LAMPIRAN1_DI);
                ...
                trform1gdr.RFR_LAMPIRAN4_DI = RFR_LAMPIRAN4_DI;
                ...
                trform1gdr.URUTAN_USER_CURRENT = URUTAN;
                trform1gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                TrForm1Gdr.UpdateDiterimaLain3(trform1gdr);
                ...
                trform1gdractivity.KODE_FORM = Common.KD_FORM_VM;
                trform1gdractivity.NO_FORM = NO_FORM;
                trform1gdractivity.STATUS = EApprovalStatus.ApprovedDI;
                trform1gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.ApprovedCreativeManagerPG + " To " + EApprovalStatus.ApprovedDI;
                trform1gdractivity.REVISION = "-";
                trform1gdractivity.URUTAN = 7;
                trform1gdractivity.SP = "";
                trform1gdractivity.USER_CURRENT = HfUsername.Value;
                trform1gdractivity.NEXT_USER = USERNEXT;
                trform1gdractivity.URUTAN_USER_CURRENT = URUTAN;
        ...
        public void UpdateStatusApprovedCreativeManagerDigitalImaging()
        {
            try
            {
                ...
                TR_FORM1_GDR trform1gdr = new TR_FORM1_GDR();
                trform1gdr.NO_FORM = NO_FORM;
                trform1gdr.DITERIMA_LAIN_4 = DITERIMA_LAIN_4;
                trform1gdr.TGL_DITERIMA_LAIN_4 = TGL_DITERIMA_LAIN_4;
                trform1gdr.STATUS = EApprovalStatus.ApprovedCreativeManagerDI;
                //trform1gdr.REVISI = "";
                Int64 ID = 0;
                string ID_DEPT_USER = "";
                string USERNEXT = "";
                ...
                trform1gdr.URUTAN_USER_CURRENT = URUTAN;
                trform1gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                TrForm1Gdr.UpdateDiterimaLain4(trform1gdr);
                ...
                trform1gdractivity.KODE_FORM = Common.KD_FORM_VM;
                trform1gdractivity.NO_FORM = NO_FORM;
                trform1gdractivity.STATUS = EApprovalStatus.ApprovedCreativeManagerDI;
                trform1gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.ApprovedDI + " To " + EApprovalStatus.ApprovedCreativeManagerDI;
                trform1gdractivity.REVISION = "-";
                trform1gdractivity.URUTAN = 8;
                trform1gdractivity.SP = "";
                trform1gdractivity.USER_CURRENT = HfUsername.Value;
                trform1gdractivity.NEXT_USER = USERNEXT;
                trform1gdractivity.URUTAN_USER_CURRENT = URUTAN;
                ...
                DivMessage.InnerText = "Data Successful Approved Creative Director-DI";
                DivMessage.Style.Add("color", "black");
                DivMessage.Style.Add("background-color", "skyblue");
                DivMessage.Attributes["class"] = "error";
                //DivMessage.Attributes["class"] = "success";
        ...
        public void UpdateStatusApprovedProductionCetakMateri()
        {
            try
            {
                ...
                TR_FORM1_GDR trform1gdr = new TR_FORM1_GDR();
                trform1gdr.NO_FORM = NO_FORM;
                trform1gdr.DITERIMA_LAIN_5_MATERI = DITERIMA_LAIN_5_MATERI;
                trform1gdr.TGL_DITERIMA_LAIN_5_MATERI = TGL_DITERIMA_LAIN_5_MATERI;
                trform1gdr.STATUS = EApprovalStatus.DoneProductionCetakMateri;
                //trform1gdr.REVISI = "";
                Int64 ID = 0;
                string ID_DEPT_USER = "";
                string USERNEXT = "";
                ...
                trform1gdr.URUTAN_USER_CURRENT = URUTAN;
                trform1gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                TrForm1Gdr.UpdateDiterimaLain5Materi(trform1gdr);
                ...
                trform1gdractivity.KODE_FORM = Common.KD_FORM_VM;
                trform1gdractivity.NO_FORM = NO_FORM;
                trform1gdractivity.STATUS = EApprovalStatus.DoneProductionCetakMateri;
                trform1gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.DoneProduction + " To " + EApprovalStatus.DoneProductionCetakMateri;
                trform1gdractivity.REVISION = "-";
                trform1gdractivity.URUTAN = 12;
                trform1gdractivity.SP = "";
                trform1gdractivity.USER_CURRENT = HfUsername.Value;
                trform1gdractivity.NEXT_USER = USERNEXT;
                trform1gdractivity.URUTAN_USER_CURRENT = URUTAN;
                ...
                DivMessage.InnerText = "Data Successful Approved Production Cetak Materi";
                DivMessage.Style.Add("color", "black");
                DivMessage.Style.Add("background-color", "skyblue");
                DivMessage.Attributes["class"] = "error";
                //DivMessage.Attributes["class"] = "success";
        ...
        public void UpdateStatusApprovedProduction()
        {
            try
            {
                ...
                TR_FORM1_GDR trform1gdr = new TR_FORM1_GDR();
                trform1gdr.NO_FORM = NO_FORM;
                trform1gdr.DITERIMA_LAIN_5 = DITERIMA_LAIN_5;
                trform1gdr.TGL_DITERIMA_LAIN_5 = TGL_DITERIMA_LAIN_5;
                trform1gdr.STATUS = EApprovalStatus.DeliveredDistribution;
                //trform1gdr.REVISI = "";
                Int64 ID = 0;
                string ID_DEPT_USER = "";
                string USERNEXT = "";
                ...
                trform1gdr.URUTAN_USER_CURRENT = URUTAN;
                trform1gdr.URUTAN_NEXT_USER = URUTAN_NEXT;
                TrForm1Gdr.UpdateDiterimaLain5(trform1gdr);
                ...
                trform1gdractivity.KODE_FORM = Common.KD_FORM_VM;
                trform1gdractivity.NO_FORM = NO_FORM;
                trform1gdractivity.STATUS = EApprovalStatus.DeliveredDistribution;
                trform1gdractivity.DESCRIPTION = "Update Status From " + EApprovalStatus.DoneProductionCetakMateri + " To " + EApprovalStatus.DeliveredDistribution;
                trform1gdractivity.REVISION = "-";
                trform1gdractivity.URUTAN = 12;
                trform1gdractivity.SP = "";
                trform1gdractivity.USER_CURRENT = HfUsername.Value;
        ...
        public void UpdateStatusCancel()
        {
            try
            {
                ...
                //trform1gdr.REVISI = "";
                trform1gdr.USER_CURRENT = HfUsername.Value;
                trform1gdr.NEXT_USER = "-";
                trform1gdr.URUTAN_USER_CURRENT = 1;
                trform1gdr.URUTAN_NEXT_USER = 0;
                ...
                trform1gdractivity.KODE_FORM = Common.KD_FORM_VM;
                trform1gdractivity.NO_FORM = NO_FORM;
                trform1gdractivity.STATUS = EApprovalStatus.Cancel;
                trform1gdractivity.DESCRIPTION = "Update Status To " + EApprovalStatus.Cancel;
                trform1gdractivity.REVISION = "-";
                trform1gdractivity.URUTAN = 1;
                trform1gdractivity.SP = "";
                trform1gdractivity.USER_CURRENT = HfUsername.Value;
                trform1gdractivity.NEXT_USER = "-";
                trform1gdractivity.URUTAN_USER_CURRENT = 1;
                trform1gdractivity.URUTAN_NEXT_USER = 0;
                TrForm1GdrActivity.Insert(trform1gdractivity);
        ...
        public void UpdateStatusCancelBM()
        {
            try
            {
                ...
                DivMessage.InnerText = "Data Successful Di Cancel";
                DivMessage.Style.Add("color", "black");
                DivMessage.Style.Add("background-color", "skyblue");
                DivMessage.Attributes["class"] = "error";
                //DivMessage.Attributes["class"] = "success";
        ...
        public void UpdateStatusCancelHDVM()
        {
            try
            {
                TR_FORM1_GDR_DA TrForm1Gdr = new DataLayer.TR_FORM1_GDR_DA();
        ...
        public void UpdateStatusCancelHeadDesign()
        {
            try
            {
                ...
                trform1gdr.STATUS = EApprovalStatus.Cancel;
                //trform1gdr.DITERIMA_2 = "";
                trform1gdr.REVISI = text_commentar.Text;
                trform1gdr.USER_CURRENT = HfUsername.Value;
                trform1gdr.NEXT_USER = "-";
                trform1gdr.URUTAN_USER_CURRENT = 1;
                trform1gdr.URUTAN_NEXT_USER = 0;
                trform1gdr.PRODUCTION = PRODUCTION;
                TrForm1Gdr.UpdateDiterima1NonJadwal(trform1gdr);
                ...
                trform1gdractivity.STATUS = EApprovalStatus.Cancel;
                trform1gdractivity.DESCRIPTION = "Update Status To " + EApprovalStatus.Cancel;
                trform1gdractivity.REVISION = text_commentar.Text;
                trform1gdractivity.URUTAN = 9;
                trform1gdractivity.SP = "";
                trform1gdractivity.USER_CURRENT = HfUsername.Value;
                trform1gdractivity.NEXT_USER = "-";
        ...
        public void UpdateStatusCancelPhotoGrapher()
        {
            try
            {
                ...
                trform1gdr.TGL_DITERIMA_LAIN_1 = TGL_DITERIMA_LAIN_1;
                trform1gdr.STATUS = EApprovalStatus.Cancel;
                trform1gdr.REVISI = KOMENTAR;
                //trform1gdr.REVISI = "";
                trform1gdr.USER_CURRENT = HfUsername.Value;
                trform1gdr.NEXT_USER = "-";
                trform1gdr.URUTAN_USER_CURRENT = 5;
                trform1gdr.URUTAN_NEXT_USER = 0;
                TrForm1Gdr.UpdateCancelDiterimaLain1(trform1gdr);
                ...
                trform1gdractivity.STATUS = EApprovalStatus.Cancel;
                trform1gdractivity.DESCRIPTION = "Update Status To " + EApprovalStatus.Cancel;
                trform1gdractivity.REVISION = KOMENTAR;
                trform1gdractivity.URUTAN = 5;
                trform1gdractivity.SP = "";
                trform1gdractivity.USER_CURRENT = HfUsername.Value;
                trform1gdractivity.NEXT_USER = "-";
                trform1gdractivity.URUTAN_USER_CURRENT = 5;
                trform1gdractivity.URUTAN_NEXT_USER = 0;
                TrForm1GdrActivity.Insert(trform1gdractivity);
        ...
        public void UpdateStatusCancelDigitalImaging()
        {
            try
            {
                ...
                trform1gdr.USER_CURRENT = HfUsername.Value;
                trform1gdr.NEXT_USER = "-";
                trform1gdr.URUTAN_USER_CURRENT = 7;
                trform1gdr.URUTAN_NEXT_USER = 0;
                TrForm1Gdr.UpdateCancelDiterimaLain3(trform1gdr);
                ...
                trform1gdractivity.USER_CURRENT = HfUsername.Value;
                trform1gdractivity.NEXT_USER = "-";
                trform1gdractivity.URUTAN_USER_CURRENT = 7;
                trform1gdractivity.URUTAN_NEXT_USER = 0;
                TrForm1GdrActivity.Insert(trform1gdractivity);
        ...
        public void UpdateStatusRevisiHD()
        {
            try
            {
                ...
                if (REVISI != "")
                {
                    ...
                    trform1gdractivity.KODE_FORM = Common.KD_FORM_VM;
                    trform1gdractivity.NO_FORM = NO_FORM;
                    trform1gdractivity.STATUS = EApprovalStatus.OnRevise;
                    trform1gdractivity.DESCRIPTION = "Update Status To " + EApprovalStatus.OnRevise;
                    trform1gdractivity.REVISION = REVISI;
                    trform1gdractivity.URUTAN = 2;
                    trform1gdractivity.SP = "";
                    trform1gdractivity.USER_CURRENT = HfUsername.Value;
        ...
        public void UpdateStatusRevisiHDVM()
        {
            try
            {
                TR_FORM1_GDR_DA TrForm1Gdr = new DataLayer.TR_FORM1_GDR_DA();
                ...
                if (REVISI != "")
                {
                    ...
                    TrForm1Gdr.UpdateRevisiMenyetujui3(trform1gdr);
        ...
        public void UpdateStatusRevisiDesign()
        {
            try
            {
                ...
                if (REVISIDESIGN != "")
                {
                    ...
                    trform1gdr.DITERIMA_3 = DITERIMA_3;
                    trform1gdr.TGL_DITERIMA_3 = TGL_DITERIMA_3;
                    trform1gdr.STATUS = EApprovalStatus.OnReviseDesign;
                    trform1gdr.REVISI = REVISIDESIGN;
                    ...
                    trform1gdractivity.KODE_FORM = Common.KD_FORM_VM;
                    trform1gdractivity.NO_FORM = NO_FORM;
                    trform1gdractivity.STATUS = EApprovalStatus.OnReviseDesign;
                    trform1gdractivity.DESCRIPTION = "Update Status To " + EApprovalStatus.OnReviseDesign;
                    trform1gdractivity.REVISION = REVISIDESIGN;
                    trform1gdractivity.URUTAN = 10;
                    trform1gdractivity.SP = "";
                    trform1gdractivity.USER_CURRENT = HfUsername.Value;
                    trform1gdractivity.NEXT_USER = USERNEXT;
        ...
        public void UpdateStatusRevisiPhotographer()
        {
            try
            {
                ...
                if (REVISI != "")
                {
                    ...
                    trform1gdr.DITERIMA_LAIN_1 = DITERIMA_LAIN_1;
                    trform1gdr.TGL_DITERIMA_LAIN_1 = TGL_DITERIMA_LAIN_1;
                    trform1gdr.STATUS = EApprovalStatus.OnRevisePhoto;
                    trform1gdr.REVISI = REVISI;
                    ...
                    TrForm1Gdr.UpdateRevisiDiterimaLain1(trform1gdr);
                    ...
                    trform1gdractivity.KODE_FORM = Common.KD_FORM_VM;
                    trform1gdractivity.NO_FORM = NO_FORM;
                    trform1gdractivity.STATUS = EApprovalStatus.OnRevisePhoto;
                    trform1gdractivity.DESCRIPTION = "Update Status To " + EApprovalStatus.OnRevisePhoto;
                    trform1gdractivity.REVISION = REVISI;
                    trform1gdractivity.URUTAN = 6;
                    trform1gdractivity.SP = "";
                    trform1gdractivity.USER_CURRENT = HfUsername.Value;
        ...
        public void UpdateStatusRevisiDigitalImaging()
        {
            try
            {
                ...
                if (REVISI != "")
                {
                    ...
                    trform1gdr.DITERIMA_LAIN_3 = DITERIMA_LAIN_3;
                    trform1gdr.TGL_DITERIMA_LAIN_3 = TGL_DITERIMA_LAIN_3;
                    trform1gdr.STATUS = EApprovalStatus.OnRevisePhotoDI;
                    trform1gdr.REVISI = REVISI;
                    ...
                    TrForm1Gdr.UpdateRevisiDiterimaLain3(trform1gdr);
                    ...
                    trform1gdractivity.KODE_FORM = Common.KD_FORM_VM;
                    trform1gdractivity.NO_FORM = NO_FORM;
                    trform1gdractivity.STATUS = EApprovalStatus.OnRevisePhotoDI;
                    trform1gdractivity.DESCRIPTION = "Update Status To " + EApprovalStatus.OnRevisePhotoDI;
                    trform1gdractivity.REVISION = REVISI;
                    trform1gdractivity.URUTAN = 8;
                    trform1gdractivity.SP = "";
                    trform1gdractivity.USER_CURRENT = HfUsername.Value;
        ...
        public void ShowButtonUrutan9()
        {
            ...
            text_menyetujui2.Enabled = false;
            text_menyetujui3.Enabled = false;
        ...
        public void ShowButtonUrutan11()
        {
            btn_Save.Visible = false;
            btn_Approved.Visible = false;
            btn_Cancel.Visible = false;
        ...
        public void ShowButtonUrutan12()
        {
            btn_Save.Visible = false;
            btn_Approved.Visible = false;
            btn_Cancel.Visible = false;
        ...
        /// <summary>
        /// Add Data Detail TR_FORM1_GDR_KATEGORI
        /// </summary>
        /// 
        ...
        public void LoadDataDetailKategoriPermintaan()
        {
            try
            {
                TR_FORM1_GDR_KATEGORI_DA TrForm1GdrKategori = new DataLayer.TR_FORM1_GDR_KATEGORI_DA();
                DataSet Ds = new DataSet();
                ...
                Ds = TrForm1GdrKategori.GetDataFilter(Where);
                ...
                foreach (DataRow Item in Ds.Tables[0].Rows)
                {
                    ...
                    //Load Group Kategori
                    if (DETAIL == "WindowTema") checkbox_windowtema.Checked = true;
                    if (DETAIL == "POPRegularA1") checkbox_POPregularA1.Checked = true;
                    if (DETAIL == "POPHiglightA1") checkbox_POPHighlightA1.Checked = true;
                    if (DETAIL == "POPRegularA3") checkbox_POPregularA3.Checked = true;
                    if (DETAIL == "POPHiglightA3") checkbox_POPHighlightA3.Checked = true;
                    if (DETAIL == "POPRegularA4") checkbox_POPregularA4.Checked = true;
                    if (DETAIL == "POPHiglightA4") checkbox_POPHighlightA4.Checked = true;
                    if (DETAIL == "POPRegularA5") checkbox_POPregularA5.Checked = true;
                    if (DETAIL == "POPHiglightA5") checkbox_POPHighlightA5.Checked = true;
                    if (DETAIL == "POPRegularA6") checkbox_POPregularA6.Checked = true;
                    if (DETAIL == "POPHiglightA6") checkbox_POPHighlightA6.Checked = true;
                    if (KODE_KATEGORI == "KP-OTHERS")
                    {
                        text_others1VM.Text = DETAIL;
                        checkbox_others1VM.Checked = true;
                    }
        ...
        public void GroupSaveKategoriPermintaan()
        {
            try
            {
                ...
                TR_FORM1_GDR_KATEGORI trform1gdrkategori = new TR_FORM1_GDR_KATEGORI();

                //Group Save Kategori
                string noform = text_noform.Text;
                string kodekategori = "KP";
                string kodekategoriothers = "KP-OTHERS";
                string windowtema = "WindowTema";
                string popregularA1 = "POPRegularA1";
                string pophiglightA1 = "POPHiglightA1";
                string popregularA3 = "POPRegularA3";
                string pophiglightA3 = "POPHiglightA3";
                string popregularA4 = "POPRegularA4";
                string pophiglightA4 = "POPHiglightA4";
                string popregularA5 = "POPRegularA5";
                string pophiglightA5 = "POPHiglightA5";
                string popregularA6 = "POPRegularA6";
                string pophiglightA6 = "POPHiglightA6";
                string other1VM = text_others1VM.Text;
                string KET = "";


                if (checkbox_windowtema.Checked == true)
                {
                    trform1gdrkategori.NO_FORM = noform;
                    trform1gdrkategori.KODE_KATEGORI = kodekategori;
                    trform1gdrkategori.DETAIL = windowtema;
                    trform1gdrkategori.ISPILIH = "Yes";
                    TrForm1GdrKategori.Insert(trform1gdrkategori);

                }

                if (checkbox_POPregularA1.Checked == true)
                {
                    trform1gdrkategori.NO_FORM = noform;
                    trform1gdrkategori.KODE_KATEGORI = kodekategori;
                    trform1gdrkategori.DETAIL = popregularA1;
                    trform1gdrkategori.ISPILIH = "Yes";
                    TrForm1GdrKategori.Insert(trform1gdrkategori);

                }

                if (checkbox_POPHighlightA1.Checked == true)
                {
                    trform1gdrkategori.NO_FORM = noform;
                    trform1gdrkategori.KODE_KATEGORI = kodekategori;
                    trform1gdrkategori.DETAIL = pophiglightA1;
                    trform1gdrkategori.ISPILIH = "Yes";
                    TrForm1GdrKategori.Insert(trform1gdrkategori);

                }

                if (checkbox_POPregularA3.Checked == true)
                {
                    trform1gdrkategori.NO_FORM = noform;
                    trform1gdrkategori.KODE_KATEGORI = kodekategori;
                    trform1gdrkategori.DETAIL = popregularA3;
                    trform1gdrkategori.ISPILIH = "Yes";
                    TrForm1GdrKategori.Insert(trform1gdrkategori);

                }

                if (checkbox_POPHighlightA3.Checked == true)
                {
                    trform1gdrkategori.NO_FORM = noform;
                    trform1gdrkategori.KODE_KATEGORI = kodekategori;
                    trform1gdrkategori.DETAIL = pophiglightA3;
                    trform1gdrkategori.ISPILIH = "Yes";
                    TrForm1GdrKategori.Insert(trform1gdrkategori);

                }

                if (checkbox_POPregularA4.Checked == true)
                {
                    trform1gdrkategori.NO_FORM = noform;
                    trform1gdrkategori.KODE_KATEGORI = kodekategori;
                    trform1gdrkategori.DETAIL = popregularA4;
                    trform1gdrkategori.ISPILIH = "Yes";
                    TrForm1GdrKategori.Insert(trform1gdrkategori);

                }

                if (checkbox_POPHighlightA4.Checked == true)
                {
                    trform1gdrkategori.NO_FORM = noform;
                    trform1gdrkategori.KODE_KATEGORI = kodekategori;
                    trform1gdrkategori.DETAIL = pophiglightA4;
                    trform1gdrkategori.ISPILIH = "Yes";
                    TrForm1GdrKategori.Insert(trform1gdrkategori);

                }

                if (checkbox_POPregularA5.Checked == true)
                {
                    trform1gdrkategori.NO_FORM = noform;
                    trform1gdrkategori.KODE_KATEGORI = kodekategori;
                    trform1gdrkategori.DETAIL = popregularA5;
                    trform1gdrkategori.ISPILIH = "Yes";
                    TrForm1GdrKategori.Insert(trform1gdrkategori);

                }

                if (checkbox_POPHighlightA5.Checked == true)
                {
                    trform1gdrkategori.NO_FORM = noform;
                    trform1gdrkategori.KODE_KATEGORI = kodekategori;
                    trform1gdrkategori.DETAIL = pophiglightA5;
                    trform1gdrkategori.ISPILIH = "Yes";
                    TrForm1GdrKategori.Insert(trform1gdrkategori);
                ...
                if (checkbox_POPregularA6.Checked == true)
                {
                    trform1gdrkategori.NO_FORM = noform;
                    trform1gdrkategori.KODE_KATEGORI = kodekategori;
                    trform1gdrkategori.DETAIL = popregularA6;
                    trform1gdrkategori.ISPILIH = "Yes";
                    TrForm1GdrKategori.Insert(trform1gdrkategori);

                }

                if (checkbox_POPHighlightA6.Checked == true)
                {
                    trform1gdrkategori.NO_FORM = noform;
                    trform1gdrkategori.KODE_KATEGORI = kodekategori;
                    trform1gdrkategori.DETAIL = pophiglightA6;
                    trform1gdrkategori.ISPILIH = "Yes";
                    TrForm1GdrKategori.Insert(trform1gdrkategori);

                }

                if (checkbox_others1VM.Checked == true)
                {
                    trform1gdrkategori.NO_FORM = noform;
                    trform1gdrkategori.KODE_KATEGORI = kodekategoriothers;
                    trform1gdrkategori.DETAIL = other1VM;
                    trform1gdrkategori.ISPILIH = "Yes";
                    TrForm1GdrKategori.Insert(trform1gdrkategori);
        ...
        public void GroupUpdateKategoriPermintaan()
        {
            try
            {
                ...
                TrForm1GdrKategori.DeleteFilter(Where);
        ...
        public void LoadDataDetailCustCt()
        {
            try
            {
                ...
                string Where = string.Format("KODE_FORM = 'FRM-0001' AND NO_FORM = '{0}'", NO_FORM);
        ...
        /// <summary>
        /// Add Data Pop Up Detail TR_FORM1_GDR_MATERI
        /// </summary>
        ...
        public void LoadDataDetailMateri()
        {
            try
            {
                ...
                Ds = TrForm1GdrMateri.GetDataFilter(Where);
        ...
        public void SaveDetailMateriCetak()
        {
            try
            {
                ...
                foreach (GridViewRow Item in gvMain.Rows)
                {
                    ...
                    TR_FORM1_GDR_MATERI trform1gdrmateri = new TR_FORM1_GDR_MATERI();
                    //trform1gdrmateri.ID_MATERI = ID_MATERI;
                    trform1gdrmateri.NO_FORM = NO_FORM;
                    trform1gdrmateri.site = site;
                    trform1gdrmateri.nama_cust = nama_cust;
                    trform1gdrmateri.JENIS_MATERIAL_CETAK = JENIS_MATERIAL_CETAK;
                    trform1gdrmateri.UKURAN = UKURAN;
                    trform1gdrmateri.MATERIAL = MATERIAL;
                    trform1gdrmateri.JUMLAH_QTY = Convert.ToDecimal(JUMLAH_QTY);
                    trform1gdrmateri.PENJELASAN = PENJELASAN;
                    TrForm1GdrMateri.Insert(trform1gdrmateri);
        ...
        public void UpdateDetailMateriCetak()
        {
            try
            {
                ...
                TrForm1GdrMateri.DeleteFilter(Where);
                SaveDetailMateriCetak();
        ...
        public void SendEmailAllType()
        {
            ...
            {
                DataSet DsForm = new DataSet();
                TR_FORM1_GDR_DA TrForm1DA = new TR_FORM1_GDR_DA();

                //Mendapatkan Status Form Berdasarkan No Form
                string NO_FORM = text_noform.Text;
                string Status = "";
                DsForm = TrForm1DA.GetDataByKey(NO_FORM);
                ...
                if (DsForm.Tables[0].Rows.Count > 0)
                {
                    ...
                    switch (Status)
                    {
                        case "Submit":
                            ...
                            //SendEmailApprovedHeadVMToHeadDesign();
                            break;
                        case "Approved-Head-Department":
                            SendEmailApprovedHDToBM();
                            break;
                        case "Approved-Brand-Manager":
                            SendEmailApprovedBMToHeadVM();
                            break;
                        case "Approved-Head-VM":
                            SendEmailApprovedHeadVMToHeadDesign();
                            break;
                        case "Approved-Head-VM-Photo":
                            SendEmailApprovedHeadVMToPhoto();
                            break;
                        case "Approved-Head-VM-DI":
                            SendEmailApprovedHeadVMToDI();
                            break;
                        case "Approved-Photo":
        ...
        public void SendEmailApprovedHDToBM()
        {
            try
            {
                string Dept = label_departmentvalue.Text;
        ...
        public void SendEmailApprovedBMToHeadVM()
        {
            try
            {
                string Dept = label_departmentvalue.Text;
                ...
                if (Ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    string EmailTemplateEng = "Dear Head VM ,<br />" + USERNAME + "<br /><br />Mohon konfirmasi untuk persetujuan dokumen berikut: <br />No Dokumen: " + NO_FORM + "<br />Jenis Form:  " + FORM_TYPE + "<br/>Brand: " + BRAND + "<br/>PIC: " + DIBUAT + "<br/>Request Date: " + TGL_REQUEST + "<br/>Required Date: " + TGL_REQUIRED + "<br/>Untuk persetujuan dapat melakukan klik <br/> {0}<br /><br /><br />Regards,<br /><b>Automatic Delami Sender</b>";
        ...
        public void SendEmailApprovedHeadVMToHeadDesign()
        {
            try
            {
                string Dept = label_departmentvalue.Text;
        ...
        public void SendEmailApprovedHeadVMToPhoto()
        {
            try
            {
                string Dept = label_departmentvalue.Text;
                ...
                if (Ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    string EmailTemplateEng = "Dear Fotografer,<br />" + USERNAME + "<br /><br />Mohon konfirmasi untuk persetujuan Design berikut: <br />No Dokumen: " + NO_FORM + "<br />Jenis Form:  " + FORM_TYPE + "<br/>PIC: " + DIBUAT + "<br/>Request Date: " + TGL_REQUEST + "<br/>Required Date: " + TGL_REQUIRED + "<br/>Untuk persetujuan dapat melakukan klik <br/> {0}<br /><br /><br />Regards,<br /><b>Automatic Delami Sender</b>";
        ...
        public void SendEmailApprovedHeadVMToDI()
        {
            try
            {
                string Dept = label_departmentvalue.Text;
        ...
        public void SendEmailReviseToUser()
        {
            try
            {
                ...
                if (Ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (!String.IsNullOrEmpty(Convert.ToString(Ds.Tables[0].Rows[0]["MENYETUJUI2"].ToString())))
                    {
                        MENYETUJUI_2 = Convert.ToString(Ds.Tables[0].Rows[0]["MENYETUJUI2"].ToString());
                    }

                    if (!String.IsNullOrEmpty(Convert.ToString(Ds.Tables[0].Rows[0]["MENYETUJUI3"].ToString())))
                    {
                        MENYETUJUI_3 = Convert.ToString(Ds.Tables[0].Rows[0]["MENYETUJUI3"].ToString());
                    }
                    ...
                    DataSet DsBrandManager = new DataSet();
                    DataSet DsHeadVM = new DataSet();
                    ...
                    //Mendapatkan Urutan Brand Manager Berdasarkan Jabatan
                    DsBrandManager = MsUserDA.GetDataUrutanUser(MENYETUJUI_2, KODE_FORM);
                    if (DsBrandManager.Tables[0].Rows.Count > 0)
                    {
                        Email = DsBrandManager.Tables[0].Rows[0]["EMAIL"].ToString();
                        string KD_JABATAN = Convert.ToString(DsBrandManager.Tables[0].Rows[0]["KD_JABATAN"].ToString());
                        URUTAN = Convert.ToString(DsBrandManager.Tables[0].Rows[0]["URUTAN"].ToString());

                        string EmailTemplateEng = "Dear Brand Manager,<br />" + MENYETUJUI_2 + "<br /><br />Terkait atas pengajuan dokumen berikut: <br />No Dokumen: " + NO_FORM + "<br />Jenis Form:  " + FORM_TYPE + "<br/>Brand: " + BRAND + "<br/>PIC: " + DIBUAT + "<br/>Request Date: " + TGL_REQUEST + "<br/>Required Date: " + TGL_REQUIRED + "<br/>Telah Dilakukan Revisi oleh: " + HfUsername.Value + " <br/>dengan Alasan " + REVISI + "Mohon konfirmasinya dengan melakukan klik <br/> {0}<br /><br /><br />Regards,<br /><b>Automatic Delami Sender</b>";

                        string TempGuid = Guid.NewGuid().ToString();
                        string Url = string.Format(EmailSetting.EmailResetPath, ("Account/Login.aspx?st="
                                        + (TempGuid + ("&uid=" + MENYETUJUI_2))));
                        string MailMessage = string.Format(EmailTemplateEng, Url);
                    ...
                    //Mendapatkan Urutan Head VM Berdasarkan Jabatan
                    DsHeadVM = MsUserDA.GetDataUrutanUser(MENYETUJUI_3, KODE_FORM);
                    if (DsHeadVM.Tables[0].Rows.Count > 0)
                    {
                        Email = DsHeadVM.Tables[0].Rows[0]["EMAIL"].ToString();
                        string KD_JABATAN = Convert.ToString(DsHeadVM.Tables[0].Rows[0]["KD_JABATAN"].ToString());
                        URUTAN = Convert.ToString(DsHeadVM.Tables[0].Rows[0]["URUTAN"].ToString());

                        string EmailTemplateEng = "Dear Head VM,<br />" + MENYETUJUI_3 + "<br /><br />Terkait atas pengajuan dokumen berikut: <br />No Dokumen: " + NO_FORM + "<br />Jenis Form:  " + FORM_TYPE + "<br/>Brand: " + BRAND + "<br/>PIC: " + DIBUAT + "<br/>Request Date: " + TGL_REQUEST + "<br/>Required Date: " + TGL_REQUIRED + "<br/>Telah Dilakukan Revisi oleh: " + HfUsername.Value + "<br/>dengan Alasan " + REVISI + "Mohon konfirmasinya dengan melakukan klik <br/> {0}<br /><br /><br />Regards,<br /><b>Automatic Delami Sender</b>";

                        string TempGuid = Guid.NewGuid().ToString();
                        string Url = string.Format(EmailSetting.EmailResetPath, ("Account/Login.aspx?st="
                                        + (TempGuid + ("&uid=" + MENYETUJUI_3))));
                        string MailMessage = string.Format(EmailTemplateEng, Url);
            ...
            try
            {
                ...
                if (Ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (DsHeadVM.Tables[0].Rows.Count > 0)
                    {
                        ...
                        string EmailTemplateEng = "Dear Head VM,<br />" + MENYETUJUI_3 + "<br /><br />Terkait atas pengajuan berikut: <br />No Dokumen: " + NO_FORM + "<br />Jenis Form:  " + FORM_TYPE + "<br/>Brand: " + BRAND + "<br/>PIC: " + DIBUAT + "<br/>Request Date: " + TGL_REQUEST + "<br/>Required Date: " + TGL_REQUIRED + "<br/>Telah Dilakukan Cancel oleh: " + HfUsername.Value + "<br/>Mohon konfirmasinya dengan melakukan klik <br/> {0}<br /><br /><br />Regards,<br /><b>Automatic Delami Sender</b>";
