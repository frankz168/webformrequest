<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="I_FormRequestGDR_VM.aspx.cs" MasterPageFile="~/Site.Master" Inherits="WebDelamiFormRequest.Forms_Data_Process.I_FormRequestGDR_VM" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            $("[id*=btn_AddData]").click(function () {
                var jenis_materi_cetak = $("[id*=text_jenismatericetak]").val();
                if (jenis_materi_cetak != "" ) {
                    var row = $("[id*=gvMain] tr:last").clone();
                    $("td:nth-child(1)", row).html(jenis_materi_cetak);
                    $("[id*=gvMain] tbody").append(row);
                }
                $("[id*=text_jenismatericetak]").val('');
                return false;
            });
        });
    </script>--%>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="PanelMain" runat="server">
        <div>
            ...
            <br />
            <h1>FORM REQUEST GRAFIS - GRAPHIC DESIGN (GDR)-VM</h1>
            <hr />
            ...
            <table>
                ...
                <asp:Panel ID="Pnl_KategoriPermintaan" runat="server" Visible="true">
                    <tr>
                        ...
                        <td class="FV270">
                            <asp:CheckBox ID="checkbox_windowtema" runat="server" Text="" Font-Size="xx-Small" GroupName="KP" />
                            <asp:Label ID="label_windowtema" runat="server" Text="Window Tema" Font-Size="Small"></asp:Label>
                        </td>
                        <td class="FV270">
                            <asp:CheckBox ID="checkbox_others1VM" runat="server" Text="" Font-Size="XX-Small" />
                            <asp:TextBox ID="text_others1VM" runat="server" Text="" Font-Size="Small" Width="130px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="FN150"></td>
                        <td class="FV270">
                            <asp:CheckBox ID="checkbox_POPregularA1" runat="server" Text="" Font-Size="xx-Small" GroupName="KP" />
                            <asp:Label ID="label_POPregularA1" runat="server" Text="POP Regular A1 Entrance" Font-Size="Small"></asp:Label>
                        </td>
                        <td class="FV270">
                            <asp:CheckBox ID="checkbox_POPHighlightA1" runat="server" Text="" Font-Size="xx-Small" GroupName="KP" />
                            <asp:Label ID="label_POPHighlightA1" runat="server" Text="POP Highlight A1 Entrance" Font-Size="Small"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="FN150"></td>
                        <td class="FV270">
                            <asp:CheckBox ID="checkbox_POPregularA3" runat="server" Text="" Font-Size="XX-Small" GroupName="KP" />
                            <asp:Label ID="label_POPregularA3" runat="server" Text="POP Regular A3 Table" Font-Size="Small"></asp:Label>
                        </td>
                        <td class="FV270">
                            <asp:CheckBox ID="checkbox_POPHighlightA3" runat="server" Text="" Font-Size="xx-Small" GroupName="KP" />
                            <asp:Label ID="label_POPHighlightA3" runat="server" Text="POP Highlight A3 Table" Font-Size="Small"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="FN150"></td>
                        <td class="FV270">
                            <asp:CheckBox ID="checkbox_POPregularA4" runat="server" Text="" Font-Size="XX-Small" GroupName="KP" />
                            <asp:Label ID="label_POPregularA4" runat="server" Text="POP Regular A4 Wall/Table" Font-Size="Small"></asp:Label>
                        </td>
                        <td class="FV270">
                            <asp:CheckBox ID="checkbox_POPHighlightA4" runat="server" Text="" Font-Size="xx-Small" GroupName="KP" />
                            <asp:Label ID="label_POPHighlightA4" runat="server" Text="POP Highlight A4 Wall/Table" Font-Size="Small"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="FN150"></td>
                        <td class="FV270">
                            <asp:CheckBox ID="checkbox_POPregularA5" runat="server" Text="" Font-Size="XX-Small" GroupName="KP" />
                            <asp:Label ID="label_POPregularA5" runat="server" Text="POP Regular A5 Prong/Cashier" Font-Size="Small"></asp:Label>
                        </td>
                        <td class="FV270">
                            <asp:CheckBox ID="checkbox_POPHighlightA5" runat="server" Text="" Font-Size="xx-Small" GroupName="KP" />
                            <asp:Label ID="label_POPHighlightA5" runat="server" Text="POP Highlight A5 Prong/Cashier" Font-Size="Small"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="FN150"></td>
                        <td class="FV270">
                            <asp:CheckBox ID="checkbox_POPregularA6" runat="server" Text="" Font-Size="XX-Small" GroupName="KP" />
                            <asp:Label ID="label_POPregularA6" runat="server" Text="POP Regular A6 Cashier" Font-Size="Small"></asp:Label>
                        </td>
                        <td class="FV270">
                            <asp:CheckBox ID="checkbox_POPHighlightA6" runat="server" Text="" Font-Size="xx-Small" GroupName="KP" />
                            <asp:Label ID="label_POPHighlightA6" runat="server" Text="POP Highlight A6 Cashier" Font-Size="Small"></asp:Label>
                        </td>
                    </tr>
                </asp:Panel>
                ...
                <asp:Panel ID="Pnl_Production" runat="server" Visible="true">
                    <tr>
                        <td class="FN150">
                            <asp:Label ID="label_production" runat="server" Text="Material Printed Or No? By Inhouse Production: "></asp:Label>
                        </td>
                        <td class="FV270">
                ...
                <asp:Panel ID="Pnl_FormOthers1" runat="server">
                    ...
                    <tr>
                        ...
                        <td class="FV270">
                            ...
                            <asp:Button ID="btnFilenameStoreClear" runat="server" Text="Clear" OnClick="btnFilenameStoreClear_Click" PostBackUrl="~/Forms_Data_Process/I_FormRequestGDR_VM.aspx"></asp:Button>
                        </td>
                    </tr>
                    <tr>
                        <td class="FN150">
                ...
                <asp:Panel ID="Pnl_Acarabktoko" runat="server" Visible="false">
                    <tr>
                        <td class="FN150">
                            <asp:Label ID="label_jadwalacarabktoko" runat="server" Text="Schedule Opening Store/Counter/Bazar: (*)"></asp:Label>
                        </td>
                        <td class="FV270">
                ...
                <asp:Panel ID="Pnl_FormOthers2" runat="server">
                    ...
                    <tr>
                        <td class="FN150">
                            <asp:Label ID="label_alokasibudget" runat="server" Text="Allocation Budget: (*)"></asp:Label>
                        </td>
                        <td class="FV270">
                    ...
                    <tr>
                        ...
                        <td class="FV270" colspan="3">
                            <div class="EU_TableScrollCustom" style="display: block; max-height: 700px;">
                                <asp:GridView ID="gvMain" runat="server" ShowHeaderWhenEmpty="true"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="ID_MATERI" HeaderText="Id materi" SortExpression="ID_materi" Visible="false" />
                                        <asp:BoundField DataField="NO_FORM" HeaderText="No Form" Visible="false" />
                ...
                <tr>
                    <td class="FN150">
                        <asp:Label ID="label_menyetujui3" runat="server" Text="Head Manager VM: " Width="170px"></asp:Label>
                    </td>
                    <td class="FV270">
                        <asp:TextBox ID="text_menyetujui3" runat="server" ReadOnly="true"></asp:TextBox>
                    </td>
                    <td class="FN150">
                        <asp:Label ID="label_tanggalmenyetujui3" runat="server" Text="Date Approved Form:" Width="170px"></asp:Label>
                    </td>
                    <td class="FV270">
                        <asp:TextBox ID="text_tanggalmenyetujui3" runat="server" ReadOnly="true" TextMode="Date"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="FN150">
                ...
                <asp:Panel ID="Pnl_RevisiLoad" runat="server" Visible="false">
                    <tr>
                        <td class="FN150">
                            <asp:Label ID="label_revisiload" runat="server" Text="Revisi: " Width="170px"></asp:Label>
                        </td>
                        <td class="FV270">
                ...
                <asp:Panel ID="Pnl_Commentar" runat="server" Visible="false">
                    <tr>
                        <td class="FN150">
                            <asp:Label ID="label_commentar" runat="server" Text="Komentar: " Width="170px"></asp:Label>
                        </td>
                        <td class="FV270">
    ...
    <div id="HiddenFields">
        ...
        <asp:HiddenField ID="HfDigitalImaging" runat="server" />
