...
{
    public partial class L_FormRequestGDR_Iklan : System.Web.UI.Page
    {
            ...
            try
            {
                if (e.CommandName.ToLower() != "page")
                {
                    ...
                    if (e.CommandName == "ClickRow")
                    {
                        ...
                        Response.Redirect("~/Forms_Data_Process/I_FormRequestGDR_Iklan.aspx?NO_FORM=" + HfNO_FORM.Value);
                    }
        ...
        {
            Response.Redirect("~/Forms_Data_Process/I_FormRequestGDR_Iklan.aspx");
        }
