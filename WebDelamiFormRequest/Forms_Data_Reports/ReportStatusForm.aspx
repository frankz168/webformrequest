<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportStatusForm.aspx.cs" MasterPageFile="~/Site.Master" Inherits="WebDelamiFormRequest.Forms_Data_Reports.ReportStatusForm" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="PanelMain" runat="server">
        <div>
            ...
            <h1>REPORT DATA SEMUA FORM REQUEST</h1>
            <hr />
            ...
            <table>
                <tr>
                    <td class="FN150">
                        <asp:Label ID="label_kodeform" runat="server" Text="Kode Form: " Width="210px"></asp:Label>
                    </td>
                    <td class="FV270">
                        <asp:DropDownList ID="ddlkodeform" runat="server" Width="400px" Height="40px" DataSourceID="C_GridKodeForm" DataValueField="KODE_FORM" DataTextField="NM_FORM"></asp:DropDownList>
                    </td>
        ...
        <div id="GridAll">
            <asp:SqlDataSource ID="C_GridUserAll" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                SelectCommand="SELECT * FROM tf_ReportUserGdrUserStatus(@Username) order by TGL_REQUEST DESC">
                <SelectParameters>
