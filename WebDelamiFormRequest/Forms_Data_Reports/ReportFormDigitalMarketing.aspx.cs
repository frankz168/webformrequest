...
{
    public partial class ReportFormDigitalMarketing : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //{
            //    ddlkodeform.DataSourceID = "C_GridKodeFormIklan";
            //    C_GridKodeFormIklan.DataBind();
            //}
            //else
            //{
            //    ddlkodeform.DataSourceID = "C_GridKodeForm";
            //    C_GridKodeForm.DataBind();
            //}
            HfKodeForm.Value = "FRM-0004";
            gvMain.DataSourceID = "";
            gvMain.DataBind();
        ...
        public void LoadGridFormAll()
        {
            try
            {
                gvMain.DataSourceID = "C_GridUserAll";
                gvMain.DataBind();
        ...
        public void LoadGridFormFilter()
        {
            try
            {
                gvMain.DataSourceID = "C_GridUserFormFilterKodeForm";
                gvMain.DataBind();
