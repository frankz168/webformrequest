<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormRequestGraphicDesign.aspx.cs" Inherits="WebDelamiFormRequest.Menu_Forms_Detail.FormRequestGraphicDesign" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="PanelMain" runat="server">
        <div>
            ...
            <br />
            <h1>DATA SEMUA FORM REQUEST GRAPHIC DESIGN</h1>
            <hr />
    ...
    <div id="DataSources">
        <asp:SqlDataSource ID="C_Grid" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
            SelectCommand="SELECT * FROM MS_FORM WHERE KODE_FORM = 'FRM-0001' OR KODE_FORM = 'FRM-0002' OR KODE_FORM = 'FRM-0003'"></asp:SqlDataSource>
        <asp:SqlDataSource ID="C_GridIklan" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
            SelectCommand="SELECT * FROM MS_FORM WHERE KODE_FORM = 'FRM-0004'"></asp:SqlDataSource>
