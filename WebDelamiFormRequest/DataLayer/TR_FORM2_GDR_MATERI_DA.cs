...
{
    public class TR_FORM2_GDR_MATERI_DA
    {
        ...
        public virtual DataSet GetDataAll()
        {
            ...
            using (SqlCommand command = new SqlCommand(string.Format("SELECT * FROM TR_FORM2_GDR_MATERI"), CnString))
            {
        ...
        public virtual DataSet GetDataByKey(String ID_MATERI)
        {
            SqlDataAdapter adapter = new SqlDataAdapter();
            DataSet dataSet = new DataSet();
            using (SqlCommand command = new SqlCommand(string.Format("SELECT * FROM TR_FORM2_GDR_MATERI WHERE ID_MATERI = @ID_MATERI"), CnString))
            {
                command.CommandType = CommandType.Text;
        ...
        public virtual DataSet GetDataFilter(String Where)
        {
            SqlDataAdapter adapter = new SqlDataAdapter();
            DataSet dataSet = new DataSet();
            using (SqlCommand command = new SqlCommand(string.Format("SELECT * FROM TR_FORM2_GDR_MATERI WHERE {0} ", Where), CnString))
            {
                CnString.Open();
        ...
        public void Insert(TR_FORM2_GDR_MATERI trform1gdrmateri)
        {
            string newId = "Berhasil";
            try
            {

                string query = String.Format("INSERT INTO TR_FORM2_GDR_MATERI(NO_FORM, site, nama_cust, JENIS_MATERIAL_CETAK, UKURAN, MATERIAL, JUMLAH_QTY, PENJELASAN) VALUES (@NO_FORM, @site, @nama_cust, @JENIS_MATERIAL_CETAK, @UKURAN, @MATERIAL, @JUMLAH_QTY, @PENJELASAN)");
                CnString.Open();
        ...
        public void Update(TR_FORM2_GDR_MATERI trform1gdrmateri)
        {
            string newId = "Berhasil";
            try
            {

                string query = String.Format("UPDATE TR_FORM2_GDR_MATERI SET NO_FORM = @NO_FORM, site = @site, nama_cust = @nama_cust, JENIS_MATERIAL_CETAK = @JENIS_MATERIAL_CETAK, UKURAN = @UKURAN, MATERIAL = @MATERIAL, JUMLAH_QTY = @JUMLAH_QTY, PENJELASAN = @PENJELASAN WHERE ID_MATERI = @ID_MATERI ");
                CnString.Open();
        ...
        public void DeleteByKey(String ID_MATERI)
        {
            ...
            try
            {
                SqlDataAdapter adapter = new SqlDataAdapter();
                DataSet dataSet = new DataSet();
                using (SqlCommand command = new SqlCommand(string.Format("DELETE FROM TR_FORM2_GDR_MATERI  WHERE ID_MATERI = @ID_MATERI"), CnString))
                {
                    command.CommandType = CommandType.Text;
                    command.Parameters.Add("@ID_MATERI", ID_MATERI);
                    CnString.Open();
        ...
        public void DeleteFilter(String Where)
        {
            ...
            try
            {
                SqlDataAdapter adapter = new SqlDataAdapter();
                DataSet dataSet = new DataSet();
                using (SqlCommand command = new SqlCommand(string.Format("DELETE  FROM TR_FORM2_GDR_MATERI WHERE {0} ", Where), CnString))
                {
                    CnString.Open();
