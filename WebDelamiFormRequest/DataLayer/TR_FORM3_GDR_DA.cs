...
namespace WebDelamiFormRequest.DataLayer
{
    public class TR_FORM3_GDR_DA
    {
        ...
        public void UpdateCancelDiterimaLain1(TR_FORM3_GDR trform3gdr)
        {
            ...
            try
            {
                string query = String.Format("UPDATE TR_FORM3_GDR SET STATUS = @STATUS, REVISI = @REVISI, DITERIMA_LAIN_1 = @DITERIMA_LAIN_1, TGL_DITERIMA_LAIN_1 = @TGL_DITERIMA_LAIN_1, USER_CURRENT = @USER_CURRENT, NEXT_USER = @NEXT_USER, URUTAN_USER_CURRENT = @URUTAN_USER_CURRENT, URUTAN_NEXT_USER = @URUTAN_NEXT_USER WHERE NO_FORM = @NO_FORM ");
                CnString.Open();
        ...
        public void UpdateCancelDiterimaLain3(TR_FORM3_GDR trform3gdr)
        {
            ...
            try
            {
                string query = String.Format("UPDATE TR_FORM3_GDR SET STATUS = @STATUS, REVISI = @REVISI, DITERIMA_LAIN_3 = @DITERIMA_LAIN_3, TGL_DITERIMA_LAIN_3 = @TGL_DITERIMA_LAIN_3, USER_CURRENT = @USER_CURRENT, NEXT_USER = @NEXT_USER, URUTAN_USER_CURRENT = @URUTAN_USER_CURRENT, URUTAN_NEXT_USER = @URUTAN_NEXT_USER WHERE NO_FORM = @NO_FORM ");
                CnString.Open();
