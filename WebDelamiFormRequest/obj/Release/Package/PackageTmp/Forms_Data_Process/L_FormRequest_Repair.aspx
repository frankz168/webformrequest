<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="L_FormRequest_Repair.aspx.cs" MasterPageFile="~/Site.Master" Inherits="WebDelamiFormRequest.Forms_Data_Process.L_FormRequest_Repair" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="PanelMain" runat="server">
        <div>
            ...
            <asp:Button ID="btn_newrepair" runat="server" Text="New Form Request Repair" OnClick="btn_newrepair_Click" />
            ...
            <div class="EU_TableScroll" style="display: block; max-height: 1000px;">
                ...
                <asp:SqlDataSource ID="C_Grid" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                    SelectCommand="SELECT * FROM TR_FORM5_REPAIR WHERE DIBUAT = @USERNAME">
                    <SelectParameters>
