<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="L_FormRequestGDR_Iklan.aspx.cs" MasterPageFile="~/Site.Master" Inherits="WebDelamiFormRequest.Forms_Data_Process.L_FormRequestGDR_Iklan" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="PanelMain" runat="server">
        <div>
            ...
            <br />
            <h1>DATA SEMUA FORM REQUEST DIGITAL ADVERTISING</h1>
            <hr />
            ...
            <asp:Button ID="btn_newgdr" runat="server" Text="New Form Request - Digital Advertising" OnClick="btn_newgdr_Click" />
            ...
            <div class="EU_TableScroll" style="display: block; max-height: 1000px;">
                ...
                <asp:SqlDataSource ID="C_Grid" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                    SelectCommand="SELECT * FROM TR_FORM4_GDR WHERE DIBUAT = @USERNAME">
                    <SelectParameters>
