<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportPDC_VM.aspx.cs" MasterPageFile="~/Site.Master"  Inherits="WebDelamiFormRequest.Forms_Data_Reports.ReportPDC_VM" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="PanelMain" runat="server">
        <div>
            ...
            <h1>REPORT REQUEST APPROVED BAMBANG</h1>
            <hr />
            ...
            <dx:ASPxGridView ID="gvMain" runat="server" AutoGenerateColumns="False" DataSourceID="CT_GridFormPDC_VM" OnRowCommand="gvMain_RowCommand" KeyFieldName="NO_FORM">
            ...
            <asp:SqlDataSource ID="CT_GridFormPDC_VM" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                SelectCommand="select * from tf_ReportPDC_VM() order by TGL_REQUEST DESC"></asp:SqlDataSource>
