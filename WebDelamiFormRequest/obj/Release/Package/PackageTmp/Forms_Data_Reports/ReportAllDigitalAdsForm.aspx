<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportAllDigitalAdsForm.aspx.cs" MasterPageFile="~/Site.Master" Inherits="WebDelamiFormRequest.Forms_Data_Reports.ReportAllDigitalAdsForm" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="PanelMain" runat="server">
        <div>
            ...
            <h1>View All Task Request Digital Advertising</h1>
            <hr />
            ...
            <dx:ASPxGridView ID="gvMain" runat="server" AutoGenerateColumns="False" DataSourceID="CT_GridDigitalAdsAll" KeyFieldName="NO_FORM">
            ...
            <asp:SqlDataSource ID="CT_GridDigitalAdsAll" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                SelectCommand="select * from tf_ReportGdrDigitalAdsAll()"></asp:SqlDataSource>
